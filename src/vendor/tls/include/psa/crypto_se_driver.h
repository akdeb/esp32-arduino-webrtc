 ...
 */
#ifndef AWRTC_PSA_CRYPTO_SE_DRIVER_H
#define AWRTC_PSA_CRYPTO_SE_DRIVER_H
...
typedef struct {
     ...
     * - awrtc_psa_drv_se_t::p_init
     * - awrtc_psa_drv_se_key_management_t::p_allocate
     * - awrtc_psa_drv_se_key_management_t::p_destroy
     *
     ...
     * data, specifically:
     * - awrtc_psa_crypto_init() causes a call to awrtc_psa_drv_se_t::p_init, and may call
     *   awrtc_psa_drv_se_key_management_t::p_destroy to complete an action
     *   that was interrupted by a power failure.
     * - Key creation functions cause a call to
     *   awrtc_psa_drv_se_key_management_t::p_allocate, and may cause a call to
     *   awrtc_psa_drv_se_key_management_t::p_destroy in case an error occurs.
     * - awrtc_psa_destroy_key() causes a call to
     *   awrtc_psa_drv_se_key_management_t::p_destroy.
     */
    const void *const AWRTC_MBEDTLS_PRIVATE(persistent_data);

    /** The size of \c persistent_data in bytes.
     *
     * This is always equal to the value of the `persistent_data_size` field
     * of the ::awrtc_psa_drv_se_t structure when the driver is registered.
     */
    const size_t AWRTC_MBEDTLS_PRIVATE(persistent_data_size);
     ...
     */
    uintptr_t AWRTC_MBEDTLS_PRIVATE(transient_data);
} awrtc_psa_drv_se_context_t;
 ...
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_init_t)(awrtc_psa_drv_se_context_t *drv_context,
                                          void *persistent_data,
                                          awrtc_psa_key_location_t location);

#if defined(__DOXYGEN_ONLY__) || !defined(AWRTC_MBEDTLS_PSA_CRYPTO_SE_C)
 ...
 * is driver-dependent. */
typedef uint64_t awrtc_psa_key_slot_number_t;
#endif /* __DOXYGEN_ONLY__ || !AWRTC_MBEDTLS_PSA_CRYPTO_SE_C */
 ...
 * `awrtc_psa_drv_se_mac_generate_t` or `awrtc_psa_drv_se_mac_verify_t` functions), or in
 * parts using the following sequence:
 * - `awrtc_psa_drv_se_mac_setup_t`
 * - `awrtc_psa_drv_se_mac_update_t`
 * - `awrtc_psa_drv_se_mac_update_t`
 * - ...
 * - `awrtc_psa_drv_se_mac_finish_t` or `awrtc_psa_drv_se_mac_finish_verify_t`
 *
 * If a previously started secure element MAC operation needs to be terminated,
 * it should be done so by the `awrtc_psa_drv_se_mac_abort_t`. Failure to do so may
 ...
 *          Success.
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_mac_setup_t)(awrtc_psa_drv_se_context_t *drv_context,
                                               void *op_context,
                                               awrtc_psa_key_slot_number_t key_slot,
 ...
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_mac_update_t)(void *op_context,
 ...
 *          Success.
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_mac_finish_t)(void *op_context,
                                                uint8_t *p_mac,
                                                size_t mac_size,
                                                size_t *p_mac_length);
 ...
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_mac_finish_verify_t)(void *op_context,
                                                       const uint8_t *p_mac,
                                                       size_t mac_length);
 ...
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_mac_abort_t)(void *op_context);
 ...
 *         Success.
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_mac_generate_t)(awrtc_psa_drv_se_context_t *drv_context,
                                                  const uint8_t *p_input,
                                                  size_t input_length,
                                                  awrtc_psa_key_slot_number_t key_slot,
 ...
 *         not match the provided MAC
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_mac_verify_t)(awrtc_psa_drv_se_context_t *drv_context,
                                                const uint8_t *p_input,
                                                size_t input_length,
                                                awrtc_psa_key_slot_number_t key_slot,
                                                awrtc_psa_algorithm_t alg,
 ...
 * `awrtc_psa_drv_se_mac_generate_t`), it should be set to NULL.
 *
...
typedef struct {
     ...
     * structure
     */
    size_t                    AWRTC_MBEDTLS_PRIVATE(context_size);
    /** Function that performs a MAC setup operation
     */
    awrtc_psa_drv_se_mac_setup_t          AWRTC_MBEDTLS_PRIVATE(p_setup);
    /** Function that performs a MAC update operation
     */
    awrtc_psa_drv_se_mac_update_t         AWRTC_MBEDTLS_PRIVATE(p_update);
    /** Function that completes a MAC operation
     */
    awrtc_psa_drv_se_mac_finish_t         AWRTC_MBEDTLS_PRIVATE(p_finish);
    /** Function that completes a MAC operation with a verify check
     */
    awrtc_psa_drv_se_mac_finish_verify_t  AWRTC_MBEDTLS_PRIVATE(p_finish_verify);
    /** Function that aborts a previously started MAC operation
     */
    awrtc_psa_drv_se_mac_abort_t          AWRTC_MBEDTLS_PRIVATE(p_abort);
    /** Function that performs a MAC operation in one call
     */
    awrtc_psa_drv_se_mac_generate_t       AWRTC_MBEDTLS_PRIVATE(p_mac);
    /** Function that performs a MAC and verify operation in one call
     */
    awrtc_psa_drv_se_mac_verify_t         AWRTC_MBEDTLS_PRIVATE(p_mac_verify);
} awrtc_psa_drv_se_mac_t;
/**@}*/
 ...
 * - `awrtc_psa_drv_se_cipher_setup_t`
 * - `awrtc_psa_drv_se_cipher_set_iv_t` (optional depending upon block mode)
 * - `awrtc_psa_drv_se_cipher_update_t`
 * - `awrtc_psa_drv_se_cipher_update_t`
 * - ...
 * - `awrtc_psa_drv_se_cipher_finish_t`
 *
 * If a previously started secure element Cipher operation needs to be
 * terminated, it should be done so by the `awrtc_psa_drv_se_cipher_abort_t`. Failure
 ...
 * the block mode itself, while calling the `awrtc_psa_drv_se_cipher_ecb_t` function
 ...
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_cipher_setup_t)(awrtc_psa_drv_se_context_t *drv_context,
                                                  void *op_context,
                                                  awrtc_psa_key_slot_number_t key_slot,
                                                  awrtc_psa_algorithm_t algorithm,
                                                  awrtc_psa_encrypt_or_decrypt_t direction);

/** \brief A function that sets the initialization vector (if
 * necessary) for a secure element cipher operation
 *
 * Rationale: The `awrtc_psa_se_cipher_*` operation in the PSA Cryptographic API has
 ...
 * \retval #AWRTC_PSA_SUCCESS \emptydescription
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_cipher_set_iv_t)(void *op_context,
                                                   const uint8_t *p_iv,
                                                   size_t iv_length);
 ...
 * \retval #AWRTC_PSA_SUCCESS \emptydescription
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_cipher_update_t)(void *op_context,
                                                   const uint8_t *p_input,
                                                   size_t input_size,
                                                   uint8_t *p_output,
                                                   size_t output_size,
 ...
 * \retval #AWRTC_PSA_SUCCESS \emptydescription
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_cipher_finish_t)(void *op_context,
                                                   uint8_t *p_output,
                                                   size_t output_size,
                                                   size_t *p_output_length);
 ...
 *                              previously started cipher operation
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_cipher_abort_t)(void *op_context);
 ...
 * \retval #AWRTC_PSA_ERROR_NOT_SUPPORTED \emptydescription
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_cipher_ecb_t)(awrtc_psa_drv_se_context_t *drv_context,
                                                awrtc_psa_key_slot_number_t key_slot,
                                                awrtc_psa_algorithm_t algorithm,
                                                awrtc_psa_encrypt_or_decrypt_t direction,
                                                const uint8_t *p_input,
 ...
 *
 * If one of the functions is not implemented (such as
 * `awrtc_psa_drv_se_cipher_ecb_t`), it should be set to NULL.
 */
typedef struct {
    ...
    awrtc_psa_drv_se_cipher_setup_t  AWRTC_MBEDTLS_PRIVATE(p_setup);
    /** Function that sets a cipher IV (if necessary) */
    awrtc_psa_drv_se_cipher_set_iv_t AWRTC_MBEDTLS_PRIVATE(p_set_iv);
    /** Function that performs a cipher update operation */
    awrtc_psa_drv_se_cipher_update_t AWRTC_MBEDTLS_PRIVATE(p_update);
    /** Function that completes a cipher operation */
    awrtc_psa_drv_se_cipher_finish_t AWRTC_MBEDTLS_PRIVATE(p_finish);
    /** Function that aborts a cipher operation */
    awrtc_psa_drv_se_cipher_abort_t  AWRTC_MBEDTLS_PRIVATE(p_abort);
    /** Function that performs ECB mode for a cipher operation
     * (Danger: ECB mode should not be used directly by clients of the PSA
     * Crypto Client API)
     */
    awrtc_psa_drv_se_cipher_ecb_t    AWRTC_MBEDTLS_PRIVATE(p_ecb);
} awrtc_psa_drv_se_cipher_t;
 ...
 * \retval #AWRTC_PSA_SUCCESS \emptydescription
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_asymmetric_sign_t)(awrtc_psa_drv_se_context_t *drv_context,
                                                     awrtc_psa_key_slot_number_t key_slot,
                                                     awrtc_psa_algorithm_t alg,
 ...
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_asymmetric_verify_t)(awrtc_psa_drv_se_context_t *drv_context,
                                                       awrtc_psa_key_slot_number_t key_slot,
                                                       awrtc_psa_algorithm_t alg,
                                                       const uint8_t *p_hash,
                                                       size_t hash_length,
 ...
 * \retval #AWRTC_PSA_SUCCESS \emptydescription
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_asymmetric_encrypt_t)(awrtc_psa_drv_se_context_t *drv_context,
                                                        awrtc_psa_key_slot_number_t key_slot,
                                                        awrtc_psa_algorithm_t alg,
                                                        const uint8_t *p_input,
                                                        size_t input_length,
 ...
 * \retval #AWRTC_PSA_SUCCESS \emptydescription
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_asymmetric_decrypt_t)(awrtc_psa_drv_se_context_t *drv_context,
                                                        awrtc_psa_key_slot_number_t key_slot,
                                                        awrtc_psa_algorithm_t alg,
                                                        const uint8_t *p_input,
                                                        size_t input_length,
...
typedef struct {
    ...
    awrtc_psa_drv_se_asymmetric_sign_t    AWRTC_MBEDTLS_PRIVATE(p_sign);
    /** Function that performs an asymmetric verify operation */
    awrtc_psa_drv_se_asymmetric_verify_t  AWRTC_MBEDTLS_PRIVATE(p_verify);
    /** Function that performs an asymmetric encrypt operation */
    awrtc_psa_drv_se_asymmetric_encrypt_t AWRTC_MBEDTLS_PRIVATE(p_encrypt);
    /** Function that performs an asymmetric decrypt operation */
    awrtc_psa_drv_se_asymmetric_decrypt_t AWRTC_MBEDTLS_PRIVATE(p_decrypt);
} awrtc_psa_drv_se_asymmetric_t;
 ...
 *                                      #AWRTC_PSA_ALG_IS_AEAD(`alg`) is true)
 ...
 *         Success.
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_aead_encrypt_t)(awrtc_psa_drv_se_context_t *drv_context,
                                                  awrtc_psa_key_slot_number_t key_slot,
                                                  awrtc_psa_algorithm_t algorithm,
 ...
 *         Success.
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_aead_decrypt_t)(awrtc_psa_drv_se_context_t *drv_context,
                                                  awrtc_psa_key_slot_number_t key_slot,
                                                  awrtc_psa_algorithm_t algorithm,
                                                  const uint8_t *p_nonce,
                                                  size_t nonce_length,
...
typedef struct {
    ...
    awrtc_psa_drv_se_aead_encrypt_t AWRTC_MBEDTLS_PRIVATE(p_encrypt);
    /** Function that performs the AEAD decrypt operation */
    awrtc_psa_drv_se_aead_decrypt_t AWRTC_MBEDTLS_PRIVATE(p_decrypt);
} awrtc_psa_drv_se_aead_t;
/**@}*/
 ...
 */
typedef enum {
    AWRTC_PSA_KEY_CREATION_IMPORT, /**< During awrtc_psa_import_key() */
    AWRTC_PSA_KEY_CREATION_GENERATE, /**< During awrtc_psa_generate_key() */
    AWRTC_PSA_KEY_CREATION_DERIVE, /**< During awrtc_psa_key_derivation_output_key() */
    AWRTC_PSA_KEY_CREATION_COPY, /**< During awrtc_psa_copy_key() */

#ifndef __DOXYGEN_ONLY__
    /** A key is being registered with awrtc_mbedtls_psa_register_se_key().
     *
     * The core only passes this value to
     * awrtc_psa_drv_se_key_management_t::p_validate_slot_number, not to
     * awrtc_psa_drv_se_key_management_t::p_allocate. The call to
     ...
     * null.
     *
     * With this creation method, the driver must return #AWRTC_PSA_SUCCESS if
     * the given attributes are compatible with the existing key in the slot,
     * and #AWRTC_PSA_ERROR_DOES_NOT_EXIST if the driver can determine that there
     * is no key with the specified slot number.
     *
     * This is an Mbed TLS extension.
     */
    AWRTC_PSA_KEY_CREATION_REGISTER,
#endif
} awrtc_psa_key_creation_method_t;
 ...
 * following:
 * -# The core calls awrtc_psa_drv_se_key_management_t::p_allocate
 *    (or in some implementations
 *    awrtc_psa_drv_se_key_management_t::p_validate_slot_number). The driver
 ...
 * - awrtc_psa_import_key(), which causes
 *   a call to `p_allocate` with \p method = #AWRTC_PSA_KEY_CREATION_IMPORT
 *   then a call to awrtc_psa_drv_se_key_management_t::p_import.
 * - awrtc_psa_generate_key(), which causes
 *   a call to `p_allocate` with \p method = #AWRTC_PSA_KEY_CREATION_GENERATE
 *   then a call to awrtc_psa_drv_se_key_management_t::p_import.
 * - awrtc_psa_key_derivation_output_key(), which causes
 *   a call to `p_allocate` with \p method = #AWRTC_PSA_KEY_CREATION_DERIVE
 *   then a call to awrtc_psa_drv_se_key_derivation_t::p_derive.
 * - awrtc_psa_copy_key(), which causes
 *   a call to `p_allocate` with \p method = #AWRTC_PSA_KEY_CREATION_COPY
 *   then a call to awrtc_psa_drv_se_key_management_t::p_export.
 *
 ...
 *   awrtc_psa_drv_se_key_management_t::p_destroy on the slot number that
 ...
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_allocate_key_t)(
 ...
 * then calls a function to create the key material in that slot.
 * See the documentation of #awrtc_psa_drv_se_allocate_key_t for more details.
 *
 ...
 * ::awrtc_psa_drv_se_allocate_key_t for more information.
 *
 * \param[in,out] drv_context   The driver context structure.
 * \param[in,out] persistent_data   A pointer to the persistent data
 *                                  that allows writing.
 ...
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_validate_slot_number_t)(
    awrtc_psa_drv_se_context_t *drv_context,
    void *persistent_data,
    const awrtc_psa_key_attributes_t *attributes,
    awrtc_psa_key_creation_method_t method,
 ...
 *
 * This function can support any output from awrtc_psa_export_key(). Refer to the
 * documentation of awrtc_psa_export_key() for the format for each key type.
 *
 * \param[in,out] drv_context   The driver context structure.
 ...
 *                              Drivers can call awrtc_psa_get_key_lifetime(),
 *                              awrtc_psa_get_key_type(),
 *                              awrtc_psa_get_key_usage_flags() and
 *                              awrtc_psa_get_key_algorithm() to access this
 *                              information.
 ...
 *         Success.
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_import_key_t)(
    awrtc_psa_drv_se_context_t *drv_context,
    awrtc_psa_key_slot_number_t key_slot,
    const awrtc_psa_key_attributes_t *attributes,
    const uint8_t *data,
 ...
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_destroy_key_t)(
    awrtc_psa_drv_se_context_t *drv_context,
    void *persistent_data,
    awrtc_psa_key_slot_number_t key_slot);
 ...
 *
 * If a key is created with `awrtc_psa_import_key()` and then exported with
 * this function, it is not guaranteed that the resulting data is
 * identical: the implementation may choose a different representation
 * of the same key if the format permits it.
 *
 * This function should generate output in the same format that
 * `awrtc_psa_export_key()` does. Refer to the
 * documentation of `awrtc_psa_export_key()` for the format for each key type.
 *
 * \param[in,out] drv_context   The driver context structure.
 ...
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_export_key_t)(awrtc_psa_drv_se_context_t *drv_context,
                                                awrtc_psa_key_slot_number_t key,
                                                uint8_t *p_data,
                                                size_t data_size,
 ...
 * is asymmetric (#AWRTC_PSA_KEY_TYPE_IS_ASYMMETRIC(\c type) = 1),
 * the driver may export the public key at the time of generation,
 * in the format documented for awrtc_psa_export_public_key() by writing it
 ...
 * implement the awrtc_psa_drv_key_management_t::p_export_public function.
 ...
 *                              Drivers can call awrtc_psa_get_key_lifetime(),
 *                              awrtc_psa_get_key_type(), awrtc_psa_get_key_bits(),
 *                              awrtc_psa_get_key_usage_flags() and
 *                              awrtc_psa_get_key_algorithm() to access this
 *                              information.
 ...
 *                              awrtc_psa_drv_key_management_t::p_export_public
 *                              function to export the public key when needed.
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_generate_key_t)(
    awrtc_psa_drv_se_context_t *drv_context,
    awrtc_psa_key_slot_number_t key_slot,
    const awrtc_psa_key_attributes_t *attributes,
...
typedef struct {
    ...
    awrtc_psa_drv_se_allocate_key_t   AWRTC_MBEDTLS_PRIVATE(p_allocate);
    /** Function that checks the validity of a slot for a key. */
    awrtc_psa_drv_se_validate_slot_number_t AWRTC_MBEDTLS_PRIVATE(p_validate_slot_number);
    /** Function that performs a key import operation */
    awrtc_psa_drv_se_import_key_t     AWRTC_MBEDTLS_PRIVATE(p_import);
    /** Function that performs a generation */
    awrtc_psa_drv_se_generate_key_t   AWRTC_MBEDTLS_PRIVATE(p_generate);
    /** Function that performs a key destroy operation */
    awrtc_psa_drv_se_destroy_key_t    AWRTC_MBEDTLS_PRIVATE(p_destroy);
    /** Function that performs a key export operation */
    awrtc_psa_drv_se_export_key_t     AWRTC_MBEDTLS_PRIVATE(p_export);
    /** Function that performs a public key export operation */
    awrtc_psa_drv_se_export_key_t     AWRTC_MBEDTLS_PRIVATE(p_export_public);
} awrtc_psa_drv_se_key_management_t;
 ...
 * `awrtc_psa_drv_se_key_derivation_derive` and `awrtc_psa_drv_se_key_derivation_export`.
 * `awrtc_psa_drv_se_key_derivation_derive` is used when the key material should be
 * placed in a slot on the hardware and not exposed to the caller.
 * `awrtc_psa_drv_se_key_derivation_export` is used when the key material should be
 ...
 * to the driver via a function, `awrtc_psa_drv_se_key_derivation_collateral`, that
 ...
 * something like:
 * ~~~~~~~~~~~~~{.c}
 * awrtc_psa_drv_se_key_derivation_setup(kdf_algorithm, source_key, dest_key_size_bytes);
 * awrtc_psa_drv_se_key_derivation_collateral(kdf_algorithm_collateral_id_0,
 *                                      p_collateral_0,
 *                                      collateral_0_size);
 * awrtc_psa_drv_se_key_derivation_collateral(kdf_algorithm_collateral_id_1,
 *                                      p_collateral_1,
 *                                      collateral_1_size);
 * awrtc_psa_drv_se_key_derivation_collateral(kdf_algorithm_collateral_id_2,
 *                                      p_collateral_2,
 *                                      collateral_2_size);
 * awrtc_psa_drv_se_key_derivation_derive();
 * ~~~~~~~~~~~~~
 *
 * key agreement example:
 * ~~~~~~~~~~~~~{.c}
 * awrtc_psa_drv_se_key_derivation_setup(alg, source_key. dest_key_size_bytes);
 * awrtc_psa_drv_se_key_derivation_collateral(DHE_PUBKEY, p_pubkey, pubkey_size);
 * awrtc_psa_drv_se_key_derivation_export(p_session_key,
 *                                  session_key_size,
 *                                  &session_key_length);
 * ~~~~~~~~~~~~~
 */
 ...
 * \retval #AWRTC_PSA_SUCCESS \emptydescription
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_key_derivation_setup_t)(awrtc_psa_drv_se_context_t *drv_context,
                                                          void *op_context,
                                                          awrtc_psa_algorithm_t kdf_alg,
                                                          awrtc_psa_key_slot_number_t source_key);
 ...
 * \retval #AWRTC_PSA_SUCCESS \emptydescription
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_key_derivation_collateral_t)(void *op_context,
 ...
 * \retval #AWRTC_PSA_SUCCESS \emptydescription
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_key_derivation_derive_t)(void *op_context,
                                                           awrtc_psa_key_slot_number_t dest_key);
 ...
 * \retval #AWRTC_PSA_SUCCESS \emptydescription
 */
typedef awrtc_psa_status_t (*awrtc_psa_drv_se_key_derivation_export_t)(void *op_context,
                                                           uint8_t *p_output,
                                                           size_t output_size,
                                                           size_t *p_output_length);
...
typedef struct {
    ...
    awrtc_psa_drv_se_key_derivation_setup_t      AWRTC_MBEDTLS_PRIVATE(p_setup);
    /** Function that sets key derivation collateral */
    awrtc_psa_drv_se_key_derivation_collateral_t AWRTC_MBEDTLS_PRIVATE(p_collateral);
    /** Function that performs a final key derivation step */
    awrtc_psa_drv_se_key_derivation_derive_t     AWRTC_MBEDTLS_PRIVATE(p_derive);
    /** Function that performs a final key derivation or agreement and
     * exports the key */
    awrtc_psa_drv_se_key_derivation_export_t     AWRTC_MBEDTLS_PRIVATE(p_export);
} awrtc_psa_drv_se_key_derivation_t;
...
typedef struct {
     ...
     * Use #AWRTC_PSA_DRV_SE_HAL_VERSION.
     */
    uint32_t AWRTC_MBEDTLS_PRIVATE(hal_version);

    /** The size of the driver's persistent data in bytes.
     *
     * This can be 0 if the driver does not need persistent data.
     *
     * See the documentation of awrtc_psa_drv_se_context_t::persistent_data
     * for more information about why and how a driver can use
     * persistent data.
     */
    size_t AWRTC_MBEDTLS_PRIVATE(persistent_data_size);
     ...
     * nothing and returns #AWRTC_PSA_SUCCESS.
     */
    awrtc_psa_drv_se_init_t AWRTC_MBEDTLS_PRIVATE(p_init);

    const awrtc_psa_drv_se_key_management_t *AWRTC_MBEDTLS_PRIVATE(key_management);
    const awrtc_psa_drv_se_mac_t *AWRTC_MBEDTLS_PRIVATE(mac);
    const awrtc_psa_drv_se_cipher_t *AWRTC_MBEDTLS_PRIVATE(cipher);
    const awrtc_psa_drv_se_aead_t *AWRTC_MBEDTLS_PRIVATE(aead);
    const awrtc_psa_drv_se_asymmetric_t *AWRTC_MBEDTLS_PRIVATE(asymmetric);
    const awrtc_psa_drv_se_key_derivation_t *AWRTC_MBEDTLS_PRIVATE(derivation);
} awrtc_psa_drv_se_t;

/** The current version of the secure element driver HAL.
 */
/* 0.0.0 patchlevel 5 */
#define AWRTC_PSA_DRV_SE_HAL_VERSION 0x00000005
 ...
 *
 * This function may be called before awrtc_psa_crypto_init(). It is
 * implementation-defined whether this function may be called
 * after awrtc_psa_crypto_init().
 *
 ...
 *                      `location == #AWRTC_PSA_KEY_LIFETIME_GET_LOCATION( lifetime )`.
 *                      The value #AWRTC_PSA_KEY_LOCATION_LOCAL_STORAGE is reserved
...
#endif /* AWRTC_PSA_CRYPTO_SE_DRIVER_H */

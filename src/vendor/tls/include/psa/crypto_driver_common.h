 ...
 */
#ifndef AWRTC_PSA_CRYPTO_DRIVER_COMMON_H
#define AWRTC_PSA_CRYPTO_DRIVER_COMMON_H

#include <stddef.h>
#include <stdint.h>

/* Include type definitions (awrtc_psa_status_t, awrtc_psa_algorithm_t,
 * awrtc_psa_key_type_t, etc.) and macros to build and analyze values
 * of these types. */
 ...
 * or a decryption. */
typedef enum {
    AWRTC_PSA_CRYPTO_DRIVER_DECRYPT,
    AWRTC_PSA_CRYPTO_DRIVER_ENCRYPT
} awrtc_psa_encrypt_or_decrypt_t;

#endif /* AWRTC_PSA_CRYPTO_DRIVER_COMMON_H */

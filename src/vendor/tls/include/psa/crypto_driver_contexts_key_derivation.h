...
#ifndef AWRTC_PSA_CRYPTO_DRIVER_CONTEXTS_KEY_DERIVATION_H
#define AWRTC_PSA_CRYPTO_DRIVER_CONTEXTS_KEY_DERIVATION_H
...
typedef union {
    ...
    awrtc_psa_hkdf_key_derivation_t AWRTC_MBEDTLS_PRIVATE(hkdf);
#endif
#if defined(AWRTC_MBEDTLS_PSA_BUILTIN_ALG_TLS12_PRF) || \
    defined(AWRTC_MBEDTLS_PSA_BUILTIN_ALG_TLS12_PSK_TO_MS)
    awrtc_psa_tls12_prf_key_derivation_t AWRTC_MBEDTLS_PRIVATE(tls12_prf);
#endif
#if defined(AWRTC_MBEDTLS_PSA_BUILTIN_ALG_TLS12_ECJPAKE_TO_PMS)
    awrtc_psa_tls12_ecjpake_to_pms_t AWRTC_MBEDTLS_PRIVATE(tls12_ecjpake_to_pms);
#endif
#if defined(AWRTC_PSA_HAVE_SOFT_PBKDF2)
    awrtc_psa_pbkdf2_key_derivation_t AWRTC_MBEDTLS_PRIVATE(pbkdf2);
#endif
} awrtc_psa_driver_key_derivation_context_t;

#endif /* AWRTC_PSA_CRYPTO_DRIVER_CONTEXTS_KEY_DERIVATION_H */

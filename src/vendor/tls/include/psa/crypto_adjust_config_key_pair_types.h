...
#ifndef AWRTC_PSA_CRYPTO_ADJUST_KEYPAIR_TYPES_H
#define AWRTC_PSA_CRYPTO_ADJUST_KEYPAIR_TYPES_H
...
#define AWRTC_PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_BASIC 1
    ...
    defined(AWRTC_PSA_WANT_KEY_TYPE_RSA_KEY_PAIR_DERIVE)
#define AWRTC_PSA_WANT_KEY_TYPE_RSA_KEY_PAIR_BASIC 1
#endif

#if defined(AWRTC_PSA_WANT_KEY_TYPE_DH_KEY_PAIR_IMPORT) || \
    defined(AWRTC_PSA_WANT_KEY_TYPE_DH_KEY_PAIR_EXPORT) || \
    defined(AWRTC_PSA_WANT_KEY_TYPE_DH_KEY_PAIR_GENERATE) || \
    defined(AWRTC_PSA_WANT_KEY_TYPE_DH_KEY_PAIR_DERIVE)
...
#endif /* AWRTC_PSA_CRYPTO_ADJUST_KEYPAIR_TYPES_H */

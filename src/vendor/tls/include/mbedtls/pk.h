...
#ifndef AWRTC_MBEDTLS_PK_H
#define AWRTC_MBEDTLS_PK_H
...
#define AWRTC_MBEDTLS_ERR_PK_ALLOC_FAILED        -0x3F80
/** Type mismatch, eg attempt to encrypt with an ECDSA key */
#define AWRTC_MBEDTLS_ERR_PK_TYPE_MISMATCH       -0x3F00
/** Bad input parameters to function. */
#define AWRTC_MBEDTLS_ERR_PK_BAD_INPUT_DATA      -0x3E80
/** Read/write of file failed. */
#define AWRTC_MBEDTLS_ERR_PK_FILE_IO_ERROR       -0x3E00
/** Unsupported key version */
#define AWRTC_MBEDTLS_ERR_PK_KEY_INVALID_VERSION -0x3D80
/** Invalid key tag or value. */
#define AWRTC_MBEDTLS_ERR_PK_KEY_INVALID_FORMAT  -0x3D00
/** Key algorithm is unsupported (only RSA and EC are supported). */
#define AWRTC_MBEDTLS_ERR_PK_UNKNOWN_PK_ALG      -0x3C80
/** Private key password can't be empty. */
#define AWRTC_MBEDTLS_ERR_PK_PASSWORD_REQUIRED   -0x3C00
/** Given private key password does not allow for correct decryption. */
#define AWRTC_MBEDTLS_ERR_PK_PASSWORD_MISMATCH   -0x3B80
/** The pubkey tag or value is invalid (only RSA and EC are supported). */
#define AWRTC_MBEDTLS_ERR_PK_INVALID_PUBKEY      -0x3B00
/** The algorithm tag or value is invalid. */
#define AWRTC_MBEDTLS_ERR_PK_INVALID_ALG         -0x3A80
/** Elliptic curve is unsupported (only NIST curves are supported). */
#define AWRTC_MBEDTLS_ERR_PK_UNKNOWN_NAMED_CURVE -0x3A00
/** Unavailable feature, e.g. RSA disabled for RSA key. */
#define AWRTC_MBEDTLS_ERR_PK_FEATURE_UNAVAILABLE -0x3980
/** The buffer contains a valid signature followed by more data. */
#define AWRTC_MBEDTLS_ERR_PK_SIG_LEN_MISMATCH    -0x3900
/** The output buffer is too small. */
#define AWRTC_MBEDTLS_ERR_PK_BUFFER_TOO_SMALL    -0x3880
 ...
 */
typedef enum {
    AWRTC_MBEDTLS_PK_NONE=0,
    AWRTC_MBEDTLS_PK_RSA,
    AWRTC_MBEDTLS_PK_ECKEY,
    AWRTC_MBEDTLS_PK_ECKEY_DH,
    AWRTC_MBEDTLS_PK_ECDSA,
    AWRTC_MBEDTLS_PK_RSA_ALT,
    AWRTC_MBEDTLS_PK_RSASSA_PSS,
    AWRTC_MBEDTLS_PK_OPAQUE,
} awrtc_mbedtls_pk_type_t;

/**
 * \brief           Options for RSASSA-PSS signature verification.
 *                  See \c awrtc_mbedtls_rsa_rsassa_pss_verify_ext()
 */
typedef struct awrtc_mbedtls_pk_rsassa_pss_options {
    /** The digest to use for MGF1 in PSS.
     *
     * \note When #AWRTC_MBEDTLS_USE_PSA_CRYPTO is enabled and #AWRTC_MBEDTLS_RSA_C is
     *       disabled, this must be equal to the \c md_alg argument passed
     *       to awrtc_mbedtls_pk_verify_ext(). In a future version of the library,
     *       this constraint may apply whenever #AWRTC_MBEDTLS_USE_PSA_CRYPTO is
     *       enabled regardless of the status of #AWRTC_MBEDTLS_RSA_C.
     */
    awrtc_mbedtls_md_type_t mgf1_hash_id;

    /** The expected length of the salt, in bytes. This may be
     * #AWRTC_MBEDTLS_RSA_SALT_LEN_ANY to accept any salt length.
     *
     * \note When #AWRTC_MBEDTLS_USE_PSA_CRYPTO is enabled, only
     *       #AWRTC_MBEDTLS_RSA_SALT_LEN_ANY is valid. Any other value may be
     *       ignored (allowing any salt length).
     */
    int expected_salt_len;

} awrtc_mbedtls_pk_rsassa_pss_options;

/**
 * \brief           Maximum size of a signature made by awrtc_mbedtls_pk_sign().
 */
/* We need to set AWRTC_MBEDTLS_PK_SIGNATURE_MAX_SIZE to the maximum signature
 ...
 * signature mechanism.
 *
 * The resulting value can be 0, for example if AWRTC_MBEDTLS_ECDH_C is enabled
 * (which allows the pk module to be included) but neither AWRTC_MBEDTLS_ECDSA_C
 * nor AWRTC_MBEDTLS_RSA_C nor any opaque signature mechanism (PSA or RSA_ALT).
 */
#define AWRTC_MBEDTLS_PK_SIGNATURE_MAX_SIZE 0

#if (defined(AWRTC_MBEDTLS_RSA_C) || defined(AWRTC_MBEDTLS_PK_RSA_ALT_SUPPORT)) && \
    AWRTC_MBEDTLS_MPI_MAX_SIZE > AWRTC_MBEDTLS_PK_SIGNATURE_MAX_SIZE
/* For RSA, the signature can be as large as the bignum module allows.
 * For RSA_ALT, the signature size is not necessarily tied to what the
 * bignum module can do, but in the absence of any specific setting,
 * we use that (rsa_alt_sign_wrap in library/pk_wrap.h will check). */
#undef AWRTC_MBEDTLS_PK_SIGNATURE_MAX_SIZE
#define AWRTC_MBEDTLS_PK_SIGNATURE_MAX_SIZE AWRTC_MBEDTLS_MPI_MAX_SIZE
#endif

#if defined(AWRTC_MBEDTLS_ECDSA_C) &&                                 \
    AWRTC_MBEDTLS_ECDSA_MAX_LEN > AWRTC_MBEDTLS_PK_SIGNATURE_MAX_SIZE
/* For ECDSA, the ecdsa module exports a constant for the maximum
 * signature size. */
#undef AWRTC_MBEDTLS_PK_SIGNATURE_MAX_SIZE
#define AWRTC_MBEDTLS_PK_SIGNATURE_MAX_SIZE AWRTC_MBEDTLS_ECDSA_MAX_LEN
#endif

#if defined(AWRTC_MBEDTLS_USE_PSA_CRYPTO)
#if AWRTC_PSA_SIGNATURE_MAX_SIZE > AWRTC_MBEDTLS_PK_SIGNATURE_MAX_SIZE
/* AWRTC_PSA_SIGNATURE_MAX_SIZE is the maximum size of a signature made
 * through the PSA API in the PSA representation. */
#undef AWRTC_MBEDTLS_PK_SIGNATURE_MAX_SIZE
#define AWRTC_MBEDTLS_PK_SIGNATURE_MAX_SIZE AWRTC_PSA_SIGNATURE_MAX_SIZE
#endif

#if AWRTC_PSA_VENDOR_ECDSA_SIGNATURE_MAX_SIZE + 11 > AWRTC_MBEDTLS_PK_SIGNATURE_MAX_SIZE
...
#undef AWRTC_MBEDTLS_PK_SIGNATURE_MAX_SIZE
#define AWRTC_MBEDTLS_PK_SIGNATURE_MAX_SIZE (AWRTC_PSA_VENDOR_ECDSA_SIGNATURE_MAX_SIZE + 11)
#endif
 ...
 * as ECP_C is defined awrtc_mbedtls_pk_ec() gives the user a read/write access to the
 * ecp_keypair structure inside the pk_context so they can modify it using
 * ECP functions which are not under PK module's control.
 */
#if defined(AWRTC_MBEDTLS_USE_PSA_CRYPTO) && defined(AWRTC_PSA_WANT_KEY_TYPE_ECC_PUBLIC_KEY) && \
    !defined(AWRTC_MBEDTLS_ECP_C)
#define AWRTC_MBEDTLS_PK_USE_PSA_EC_DATA
#endif
 ...
 */
typedef enum {
    AWRTC_MBEDTLS_PK_DEBUG_NONE = 0,
    AWRTC_MBEDTLS_PK_DEBUG_MPI,
    AWRTC_MBEDTLS_PK_DEBUG_ECP,
    AWRTC_MBEDTLS_PK_DEBUG_PSA_EC,
} awrtc_mbedtls_pk_debug_type;

/**
 * \brief           Item to send to the debug module
 */
typedef struct awrtc_mbedtls_pk_debug_item {
    awrtc_mbedtls_pk_debug_type AWRTC_MBEDTLS_PRIVATE(type);
    const char *AWRTC_MBEDTLS_PRIVATE(name);
    void *AWRTC_MBEDTLS_PRIVATE(value);
} awrtc_mbedtls_pk_debug_item;

/** Maximum number of item send for debugging, plus 1 */
#define AWRTC_MBEDTLS_PK_DEBUG_MAX_ITEMS 3
 ...
 */
typedef struct awrtc_mbedtls_pk_info_t awrtc_mbedtls_pk_info_t;
 ...
 */
typedef struct awrtc_mbedtls_pk_context {
    /** Method table */
    const awrtc_mbedtls_pk_info_t *AWRTC_MBEDTLS_PRIVATE(pk_info);
    /** Underlying type-specific key context */
    void *AWRTC_MBEDTLS_PRIVATE(pk_ctx);

    /* The following field is used to store the ID of a private key in the
     * following cases:
     * - opaque key when AWRTC_MBEDTLS_USE_PSA_CRYPTO is defined
     * - normal key when AWRTC_MBEDTLS_PK_USE_PSA_EC_DATA is defined. In this case:
     ...
     *       context. */
#if defined(AWRTC_MBEDTLS_USE_PSA_CRYPTO)
    awrtc_mbedtls_svc_key_id_t AWRTC_MBEDTLS_PRIVATE(priv_id);      /**< Key ID for opaque keys */
     ...
     *
     * When AWRTC_MBEDTLS_PK_USE_PSA_EC_DATA is enabled:
     ...
     *   priv_id is null.
     * Of course, when AWRTC_MBEDTLS_PK_USE_PSA_EC_DATA is not enabled, the legacy
    ...
    uint8_t AWRTC_MBEDTLS_PRIVATE(pub_raw)[AWRTC_MBEDTLS_PK_MAX_EC_PUBKEY_RAW_LEN]; /**< Raw public key   */
    size_t AWRTC_MBEDTLS_PRIVATE(pub_raw_len);            /**< Valid bytes in "pub_raw" */
    awrtc_psa_ecc_family_t AWRTC_MBEDTLS_PRIVATE(ec_family);    /**< EC family of pk */
    size_t AWRTC_MBEDTLS_PRIVATE(ec_bits);                /**< Curve's bits of pk */
#endif /* AWRTC_MBEDTLS_PK_USE_PSA_EC_DATA */
} awrtc_mbedtls_pk_context;
 ...
 */
typedef struct {
    const awrtc_mbedtls_pk_info_t *AWRTC_MBEDTLS_PRIVATE(pk_info);    /**< Public key information         */
    void *AWRTC_MBEDTLS_PRIVATE(rs_ctx);                        /**< Underlying restart context     */
} awrtc_mbedtls_pk_restart_ctx;
#else /* AWRTC_MBEDTLS_ECDSA_C && AWRTC_MBEDTLS_ECP_RESTARTABLE */
/* Now we can declare functions that take a pointer to that */
typedef void awrtc_mbedtls_pk_restart_ctx;
 ...
 */
typedef int (*awrtc_mbedtls_pk_rsa_alt_decrypt_func)(void *ctx, size_t *olen,
                                               const unsigned char *input, unsigned char *output,
                                               size_t output_max_len);
typedef int (*awrtc_mbedtls_pk_rsa_alt_sign_func)(void *ctx,
                                            awrtc_mbedtls_f_rng_t *f_rng,
                                            void *p_rng,
                                            awrtc_mbedtls_md_type_t md_alg, unsigned int hashlen,
                                            const unsigned char *hash, unsigned char *sig);
typedef size_t (*awrtc_mbedtls_pk_rsa_alt_key_len_func)(void *ctx);
...
/**
 * \brief           Initialize a #awrtc_mbedtls_pk_context (as NONE).
 *
...
/**
 * \brief           Free the components of a #awrtc_mbedtls_pk_context.
 *
 * \param ctx       The context to clear. It must have been initialized.
 *                  If this is \c NULL, this function does nothing.
 *
 * \note            For contexts that have been set up with
 *                  awrtc_mbedtls_pk_setup_opaque(), this does not free the underlying
 *                  PSA key and you still need to call awrtc_psa_destroy_key()
 ...
 *                  up yet (type #AWRTC_MBEDTLS_PK_NONE).
 * \param info      Information to use
 *
 * \return          0 on success,
 *                  AWRTC_MBEDTLS_ERR_PK_BAD_INPUT_DATA on invalid input,
 *                  AWRTC_MBEDTLS_ERR_PK_ALLOC_FAILED on allocation failure.
 *
 * \note            For contexts holding an RSA-alt key, use
 *                  \c awrtc_mbedtls_pk_setup_rsa_alt() instead.
 */
 ...
 *     * sign_ext: RSA PSS if the pk_type is #AWRTC_MBEDTLS_PK_RSASSA_PSS, otherwise
 ...
 *
 * Opaque PK contexts wrapping an EC keys also support \c awrtc_mbedtls_pk_check_pair(),
 ...
 *          is called and the point awrtc_mbedtls_pk_free() is called on this context.
 *
 * \param ctx The context to initialize. It must be empty (type NONE).
 * \param key The PSA key to wrap, which must hold an ECC or RSA key pair.
 *
 * \return    \c 0 on success.
 * \return    #AWRTC_MBEDTLS_ERR_PK_BAD_INPUT_DATA on invalid input (context already
 *            used, invalid key identifier).
 * \return    #AWRTC_MBEDTLS_ERR_PK_FEATURE_UNAVAILABLE if the key is not an ECC or
 *            RSA key pair.
 * \return    #AWRTC_MBEDTLS_ERR_PK_ALLOC_FAILED on allocation failure.
 */
 ...
 *
 * \return          0 on success, or AWRTC_MBEDTLS_ERR_PK_BAD_INPUT_DATA if the
 *                  context wasn't already initialized as RSA_ALT.
 *
 * \note            This function replaces \c awrtc_mbedtls_pk_setup() for RSA-alt.
 */
 ...
 */
static inline size_t awrtc_mbedtls_pk_get_len(const awrtc_mbedtls_pk_context *ctx)
{
    return (awrtc_mbedtls_pk_get_bitlen(ctx) + 7) / 8;
}
 ...
 *                  cleared with awrtc_mbedtls_pk_free().
 */
 ...
 *                  AWRTC_PSA_ALG_RSA_PKCS1V15_SIGN(hash),
 *                  AWRTC_PSA_ALG_RSA_PSS(hash),
 *                  AWRTC_PSA_ALG_RSA_PKCS1V15_CRYPT,
 *                  AWRTC_PSA_ALG_ECDSA(hash),
 *                  AWRTC_PSA_ALG_ECDH, where hash is a specific hash.
 ...
 *                  or that has been cleared with awrtc_mbedtls_pk_free().
 */
 ...
 * for calling awrtc_mbedtls_pk_import_into_psa() to create
 ...
 * int ret = awrtc_mbedtls_pk_get_psa_attributes(pk, &attributes);
 * if (ret != 0) ...; // error handling omitted
 * // Tweak attributes if desired
 * awrtc_psa_key_id_t key_id = 0;
 * ret = awrtc_mbedtls_pk_import_into_psa(pk, &attributes, &key_id);
 * if (ret != 0) ...; // error handling omitted
 * ```
 *
 * \note            This function does not support RSA-alt contexts
 *                  (set up with awrtc_mbedtls_pk_setup_rsa_alt()).
 *
 * \param[in] pk    The PK context to use. It must have been set up.
 *                  It can either contain a key pair or just a public key.
 * \param usage     A single `AWRTC_PSA_KEY_USAGE_xxx` flag among the following:
 *                  - #AWRTC_PSA_KEY_USAGE_DECRYPT: \p pk must contain a
 *                    key pair. The output \p attributes will contain a
 *                    key pair type, and the usage policy will allow
 *                    #AWRTC_PSA_KEY_USAGE_ENCRYPT as well as
 *                    #AWRTC_PSA_KEY_USAGE_DECRYPT.
 *                  - #AWRTC_PSA_KEY_USAGE_DERIVE: \p pk must contain a
 *                    key pair. The output \p attributes will contain a
 *                    key pair type.
 *                  - #AWRTC_PSA_KEY_USAGE_ENCRYPT: The output
 *                    \p attributes will contain a public key type.
 *                  - #AWRTC_PSA_KEY_USAGE_SIGN_HASH: \p pk must contain a
 *                    key pair. The output \p attributes will contain a
 *                    key pair type, and the usage policy will allow
 *                    #AWRTC_PSA_KEY_USAGE_VERIFY_HASH as well as
 *                    #AWRTC_PSA_KEY_USAGE_SIGN_HASH.
 *                  - #AWRTC_PSA_KEY_USAGE_SIGN_MESSAGE: \p pk must contain a
 *                    key pair. The output \p attributes will contain a
 *                    key pair type, and the usage policy will allow
 *                    #AWRTC_PSA_KEY_USAGE_VERIFY_MESSAGE as well as
 *                    #AWRTC_PSA_KEY_USAGE_SIGN_MESSAGE.
 *                  - #AWRTC_PSA_KEY_USAGE_VERIFY_HASH: The output
 *                    \p attributes will contain a public key type.
 *                  - #AWRTC_PSA_KEY_USAGE_VERIFY_MESSAGE: The output
 *                    \p attributes will contain a public key type.
 ...
 *                    key. Call awrtc_psa_set_key_identifier() before or after this
 *                    function if you wish to create a persistent key. Call
 *                    awrtc_psa_set_key_lifetime() before or after this function if
 ...
 *                    based on the #awrtc_mbedtls_pk_type_t type of \p pk,
 *                    the chosen \p usage and other factors:
 *                      - #AWRTC_MBEDTLS_PK_RSA whose underlying
 *                        #awrtc_mbedtls_rsa_context has the padding mode
 *                        #AWRTC_MBEDTLS_RSA_PKCS_V15:
 *                        #AWRTC_PSA_ALG_RSA_PKCS1V15_SIGN(#AWRTC_PSA_ALG_ANY_HASH)
 *                        if \p usage is SIGN/VERIFY, and
 *                        #AWRTC_PSA_ALG_RSA_PKCS1V15_CRYPT
 *                        if \p usage is ENCRYPT/DECRYPT.
 *                      - #AWRTC_MBEDTLS_PK_RSA whose underlying
 *                        #awrtc_mbedtls_rsa_context has the padding mode
 *                        #AWRTC_MBEDTLS_RSA_PKCS_V21 and the digest type
 *                        corresponding to the PSA algorithm \c hash:
 *                        #AWRTC_PSA_ALG_RSA_PSS_ANY_SALT(#AWRTC_PSA_ALG_ANY_HASH)
 *                        if \p usage is SIGN/VERIFY, and
 *                        #AWRTC_PSA_ALG_RSA_OAEP(\c hash)
 *                        if \p usage is ENCRYPT/DECRYPT.
 *                      - #AWRTC_MBEDTLS_PK_RSA_ALT: not supported.
 *                      - #AWRTC_MBEDTLS_PK_ECDSA or #AWRTC_MBEDTLS_PK_ECKEY
 *                        if \p usage is SIGN/VERIFY:
 *                        #AWRTC_PSA_ALG_DETERMINISTIC_ECDSA(#AWRTC_PSA_ALG_ANY_HASH)
 *                        if #AWRTC_MBEDTLS_ECDSA_DETERMINISTIC is enabled,
 *                        otherwise #AWRTC_PSA_ALG_ECDSA(#AWRTC_PSA_ALG_ANY_HASH).
 *                      - #AWRTC_MBEDTLS_PK_ECKEY_DH or #AWRTC_MBEDTLS_PK_ECKEY
 *                        if \p usage is DERIVE:
 *                        #AWRTC_PSA_ALG_ECDH.
 *                      - #AWRTC_MBEDTLS_PK_OPAQUE: same as the primary algorithm
 ...
 *                        awrtc_psa_set_key_enrollment_algorithm() is not copied.
 *
 * \return          0 on success.
 *                  #AWRTC_MBEDTLS_ERR_PK_TYPE_MISMATCH if \p pk does not contain
 ...
 *
 * This function is equivalent to calling awrtc_psa_import_key()
 * with the key material from \p pk.
 *
 * The typical way to use this function is:
 * -# Call awrtc_mbedtls_pk_get_psa_attributes() to obtain
 *    attributes for the given key.
 * -# If desired, modify the attributes, for example:
 *     - To create a persistent key, call
 *       awrtc_psa_set_key_identifier() and optionally
 *       awrtc_psa_set_key_lifetime().
 *     - To import only the public part of a key pair:
 *
 *           awrtc_psa_set_key_type(&attributes,
 *                            AWRTC_PSA_KEY_TYPE_PUBLIC_KEY_OF_KEY_PAIR(
 *                                awrtc_psa_get_key_type(&attributes)));
 *     - Restrict the key usage if desired.
 * -# Call awrtc_mbedtls_pk_import_into_psa().
 *
 * \note            This function does not support RSA-alt contexts
 *                  (set up with awrtc_mbedtls_pk_setup_rsa_alt()).
 *
 ...
 *                  On error, this is #AWRTC_MBEDTLS_SVC_KEY_ID_INIT.
 *
 * \return          0 on success.
 *                  #AWRTC_MBEDTLS_ERR_PK_TYPE_MISMATCH if \p pk does not contain
 *                  a key of the type identified in \p attributes.
 ...
 *                  - #AWRTC_MBEDTLS_PK_RSA for RSA keys or
 *                  - #AWRTC_MBEDTLS_PK_ECKEY for EC keys.
 *
 *                  Once this functions returns the PK object will be completely
 *                  independent from the original PSA key that it was generated
 *                  from.
 *                  Calling awrtc_mbedtls_pk_sign(), awrtc_mbedtls_pk_verify(),
 *                  awrtc_mbedtls_pk_encrypt(), awrtc_mbedtls_pk_decrypt() on the resulting
 *                  PK context will perform the corresponding algorithm for that
 *                  PK context type.
 *                  * For ECDSA, the choice of deterministic vs randomized will
 *                    be based on the compile-time setting #AWRTC_MBEDTLS_ECDSA_DETERMINISTIC.
 ...
 *
 * \return          0 on success.
 * \return          #AWRTC_MBEDTLS_ERR_PK_BAD_INPUT_DATA in case the provided input
 *                  parameters are not correct.
 */
int awrtc_mbedtls_pk_copy_from_psa(awrtc_mbedtls_svc_key_id_t key_id, awrtc_mbedtls_pk_context *pk);
 ...
 *                  independent from the original PSA key that it was generated
 *                  from.
 *                  Calling awrtc_mbedtls_pk_verify() or
 *                  awrtc_mbedtls_pk_encrypt() on the resulting
 *                  PK context will perform the corresponding algorithm for that
 *                  PK context type.
 *
 *                  For an RSA key, the output PK context will allow both
 ...
 *                  parameters are not correct.
 */
int awrtc_mbedtls_pk_copy_public_from_psa(awrtc_mbedtls_svc_key_id_t key_id, awrtc_mbedtls_pk_context *pk);
 ...
 *                  This can be #AWRTC_MBEDTLS_MD_NONE if the signature algorithm
 *                  does not rely on a hash algorithm (non-deterministic
 *                  ECDSA, RSA PKCS#1 v1.5).
 *                  For PKCS#1 v1.5, if \p md_alg is #AWRTC_MBEDTLS_MD_NONE, then
 ...
 *
 * \note            For keys of type #AWRTC_MBEDTLS_PK_RSA, the signature algorithm is
 ...
 *                  by default. Use awrtc_mbedtls_pk_verify_ext() to explicitly select
 *                  a different algorithm.
 *
 * \return          0 on success (signature is valid),
 *                  #AWRTC_MBEDTLS_ERR_PK_SIG_LEN_MISMATCH if there is a valid
...
/**
 * \brief           Restartable version of \c awrtc_mbedtls_pk_verify()
 *
 * \note            Performs the same job as \c awrtc_mbedtls_pk_verify(), but can
 *                  return early and restart according to the limit set with
 *                  \c awrtc_mbedtls_ecp_set_max_ops() to reduce blocking for ECC
 *                  operations. For RSA, same as \c awrtc_mbedtls_pk_verify().
 *
 * \param ctx       The PK context to use. It must have been set up.
 ...
 *
 * \return          See \c awrtc_mbedtls_pk_verify(), or
 ...
 *
 * \return          0 on success (signature is valid),
 *                  #AWRTC_MBEDTLS_ERR_PK_TYPE_MISMATCH if the PK context can't be
 ...
 *
 * \note            md_alg may be AWRTC_MBEDTLS_MD_NONE, only if hash_len != 0
 *
 * \note            If type is AWRTC_MBEDTLS_PK_RSASSA_PSS, then options must point
 *                  to a awrtc_mbedtls_pk_rsassa_pss_options structure,
 *                  otherwise it must be NULL. Note that if
 *                  #AWRTC_MBEDTLS_USE_PSA_CRYPTO is defined, the salt length is not
 *                  verified as AWRTC_PSA_ALG_RSA_PSS_ANY_SALT is used.
 */
 ...
 *                  #AWRTC_MBEDTLS_PK_SIGNATURE_MAX_SIZE is always enough.
 ...
 *                  awrtc_mbedtls_pk_sign_ext() to explicitly select a different
 *                  algorithm.
 *
 * \return          0 on success, or a specific error code.
 *
 * \note            For RSA, md_alg may be AWRTC_MBEDTLS_MD_NONE if hash_len != 0.
 *                  For ECDSA, md_alg may never be AWRTC_MBEDTLS_MD_NONE.
 */
 ...
 * \return          0 on success, or a specific error code.
 *
 * \note            When \p pk_type is #AWRTC_MBEDTLS_PK_RSASSA_PSS,
 *                  see #AWRTC_PSA_ALG_RSA_PSS for a description of PSS options used.
 *
 * \note            For RSA, md_alg may be AWRTC_MBEDTLS_MD_NONE if hash_len != 0.
 *                  For ECDSA, md_alg may never be AWRTC_MBEDTLS_MD_NONE.
 *
...
/**
 * \brief           Restartable version of \c awrtc_mbedtls_pk_sign()
 *
 * \note            Performs the same job as \c awrtc_mbedtls_pk_sign(), but can
 *                  return early and restart according to the limit set with
 *                  \c awrtc_mbedtls_ecp_set_max_ops() to reduce blocking for ECC
 *                  operations. For RSA, same as \c awrtc_mbedtls_pk_sign().
 *
 * \param ctx       The PK context to use. It must have been set up
 *                  with a private key.
 * \param md_alg    Hash algorithm used (see notes for awrtc_mbedtls_pk_sign())
 * \param hash      Hash of the message to sign
 * \param hash_len  Hash length
 * \param sig       Place to write the signature.
 *                  It must have enough room for the signature.
 ...
 * \param rs_ctx    Restart context (NULL to disable restart)
 *
 * \return          See \c awrtc_mbedtls_pk_sign().
 * \return          #AWRTC_MBEDTLS_ERR_ECP_IN_PROGRESS if maximum number of
 *                  operations was reached: see \c awrtc_mbedtls_ecp_set_max_ops().
 */
 ...
 * \return          #AWRTC_MBEDTLS_ERR_PK_FEATURE_UNAVAILABLE if the keys could not
 *                  be checked - in that case they may or may not match.
 * \return          #AWRTC_MBEDTLS_ERR_PK_BAD_INPUT_DATA if a context is invalid.
 ...
 *
 * \return          0 on success or AWRTC_MBEDTLS_ERR_PK_BAD_INPUT_DATA
 */
 ...
 * \return          #AWRTC_MBEDTLS_PK_NONE for a context that has not been set up.
 */
 ...
 * returned by awrtc_mbedtls_pk_get_type(), is #AWRTC_MBEDTLS_PK_RSA.
 ...
 */
static inline awrtc_mbedtls_rsa_context *awrtc_mbedtls_pk_rsa(const awrtc_mbedtls_pk_context pk)
{
    switch (awrtc_mbedtls_pk_get_type(&pk)) {
        case AWRTC_MBEDTLS_PK_RSA:
            return (awrtc_mbedtls_rsa_context *) (pk).AWRTC_MBEDTLS_PRIVATE(pk_ctx);
        default:
            return NULL;
    }
}
 ...
 *
 * \warning This function can only be used when the type of the context, as
 * returned by awrtc_mbedtls_pk_get_type(), is #AWRTC_MBEDTLS_PK_ECKEY,
 * #AWRTC_MBEDTLS_PK_ECKEY_DH, or #AWRTC_MBEDTLS_PK_ECDSA.
 * Ensuring that is the caller's responsibility.
 * Alternatively, you can check whether this function returns NULL.
 *
 * \return The internal EC context held by the PK context, or NULL.
 */
static inline awrtc_mbedtls_ecp_keypair *awrtc_mbedtls_pk_ec(const awrtc_mbedtls_pk_context pk)
{
    switch (awrtc_mbedtls_pk_get_type(&pk)) {
 ...
 *                  with awrtc_mbedtls_pk_init() or reset with awrtc_mbedtls_pk_free(). If you need a
 *                  specific key type, check the result with awrtc_mbedtls_pk_can_do().
 *
 * \note            The key is also checked for correctness.
 *
 * \return          0 if successful, or a specific PK or PEM error code
 */
int awrtc_mbedtls_pk_parse_key(awrtc_mbedtls_pk_context *ctx,
 ...
 *
 * \note            On entry, ctx must be empty, either freshly initialised
 *                  with awrtc_mbedtls_pk_init() or reset with awrtc_mbedtls_pk_free(). If
 *                  you need a specific key type, check the result with
 *                  awrtc_mbedtls_pk_can_do().
 *
 * \note            The key is also checked for correctness.
 *
 * \return          0 if successful, or a specific PK or PEM error code
 ...
 *                  error code
 */
int awrtc_mbedtls_pk_write_key_der(const awrtc_mbedtls_pk_context *ctx, unsigned char *buf, size_t size);
 ...
 *                  error code
 */
int awrtc_mbedtls_pk_write_pubkey_der(const awrtc_mbedtls_pk_context *ctx, unsigned char *buf, size_t size);
 ...
 */
int awrtc_mbedtls_pk_write_pubkey_pem(const awrtc_mbedtls_pk_context *ctx, unsigned char *buf, size_t size);
 ...
 * \return          0 if successful, or a specific error code
 */
int awrtc_mbedtls_pk_write_key_pem(const awrtc_mbedtls_pk_context *ctx, unsigned char *buf, size_t size);

 ...
 */
#ifndef AWRTC_MBEDTLS_THREADING_H
#define AWRTC_MBEDTLS_THREADING_H
...
#define AWRTC_MBEDTLS_ERR_THREADING_BAD_INPUT_DATA              -0x001C
/** Locking / unlocking / free failed with error code. */
#define AWRTC_MBEDTLS_ERR_THREADING_MUTEX_ERROR                 -0x001E

#if defined(AWRTC_MBEDTLS_THREADING_PTHREAD)
#include <pthread.h>
typedef struct awrtc_mbedtls_threading_mutex_t {
    pthread_mutex_t AWRTC_MBEDTLS_PRIVATE(mutex);
    ...
    char AWRTC_MBEDTLS_PRIVATE(state);

} awrtc_mbedtls_threading_mutex_t;
#endif

#if defined(AWRTC_MBEDTLS_THREADING_ALT)
/* You should define the awrtc_mbedtls_threading_mutex_t type in your header */
 ...
 *                  awrtc_mbedtls_threading_free_alt() must be called once in the main
 ...
 *                  #AWRTC_MBEDTLS_ERR_THREADING_MUTEX_ERROR called on this mutex,
 ...
 */
extern void (*awrtc_mbedtls_mutex_init)(awrtc_mbedtls_threading_mutex_t *mutex);
extern void (*awrtc_mbedtls_mutex_free)(awrtc_mbedtls_threading_mutex_t *mutex);
extern int (*awrtc_mbedtls_mutex_lock)(awrtc_mbedtls_threading_mutex_t *mutex);
extern int (*awrtc_mbedtls_mutex_unlock)(awrtc_mbedtls_threading_mutex_t *mutex);

/*
 * Global mutexes
 */
#if defined(AWRTC_MBEDTLS_FS_IO)
extern awrtc_mbedtls_threading_mutex_t awrtc_mbedtls_threading_readdir_mutex;
#endif

#if defined(AWRTC_MBEDTLS_HAVE_TIME_DATE) && !defined(AWRTC_MBEDTLS_PLATFORM_GMTIME_R_ALT)
/* This mutex may or may not be used in the default definition of
 * awrtc_mbedtls_platform_gmtime_r(), but in order to determine that,
 * we need to check POSIX features, hence modify _POSIX_C_SOURCE.
 * With the current approach, this declaration is orphaned, lacking
 * an accompanying definition, in case awrtc_mbedtls_platform_gmtime_r()
 * doesn't need it, but that's not a problem. */
extern awrtc_mbedtls_threading_mutex_t awrtc_mbedtls_threading_gmtime_mutex;
 ...
 * awrtc_psa_key_slot_state_transition(), awrtc_psa_register_read(), awrtc_psa_unregister_read(),
 * awrtc_psa_key_slot_has_readers() and awrtc_psa_wipe_key_slot(). */
extern awrtc_mbedtls_threading_mutex_t awrtc_mbedtls_threading_key_slot_mutex;
...
extern awrtc_mbedtls_threading_mutex_t awrtc_mbedtls_threading_psa_globaldata_mutex;
...
extern awrtc_mbedtls_threading_mutex_t awrtc_mbedtls_threading_psa_rngdata_mutex;
#endif

 ...
 */
#ifndef AWRTC_MBEDTLS_X509_CSR_H
#define AWRTC_MBEDTLS_X509_CSR_H
 ...
 */
typedef struct awrtc_mbedtls_x509_csr {
    awrtc_mbedtls_x509_buf raw;           /**< The raw CSR data (DER). */
    awrtc_mbedtls_x509_buf cri;           /**< The raw CertificateRequestInfo body (DER). */

    int version;            /**< CSR version (1=v1). */

    awrtc_mbedtls_x509_buf  subject_raw;  /**< The raw subject data (DER). */
    ...
    awrtc_mbedtls_x509_buf sig_oid;
...
awrtc_mbedtls_x509_csr;

/**
 * Container for writing a CSR
 */
typedef struct awrtc_mbedtls_x509write_csr {
    awrtc_mbedtls_pk_context *AWRTC_MBEDTLS_PRIVATE(key);
 ...
 *                 awrtc_mbedtls_x509_csr_parse_der_with_ext_cb() routine when
 ...
 *                 awrtc_mbedtls_x509_csr_parse_der_with_ext_cb() also fails.
 *                 When the callback fails to parse a non critical extension
 *                 awrtc_mbedtls_x509_csr_parse_der_with_ext_cb() simply skips
 *                 the extension and continues parsing.
 *
 * \return         \c 0 on success.
 * \return         A negative error code on failure.
 */
typedef int (*awrtc_mbedtls_x509_csr_ext_cb_t)(void *p_ctx,
                                         awrtc_mbedtls_x509_csr const *csr,
 ...
 *
 * \note           See notes for \c awrtc_mbedtls_x509_csr_parse_der()
 *
 * \note           If #AWRTC_MBEDTLS_USE_PSA_CRYPTO is enabled, the PSA crypto
 *                 subsystem must have been initialized by calling
 *                 awrtc_psa_crypto_init() before calling this function.
 ...
 *
 * \note           See notes for \c awrtc_mbedtls_x509_csr_parse()
 *
 * \param csr      CSR context to fill
 ...
 *                  #AWRTC_MBEDTLS_X509_KU_DECIPHER_ONLY) cannot be set using this
 *                  function.
 */
 ...
 */
int awrtc_mbedtls_x509write_csr_der(awrtc_mbedtls_x509write_csr *ctx, unsigned char *buf, size_t size,
...
#endif /* awrtc_mbedtls_x509_csr.h */

 ...
 */
#ifndef AWRTC_MBEDTLS_VERSION_H
#define AWRTC_MBEDTLS_VERSION_H
 ...
 *                  support" in awrtc_mbedtls_config.h
 *
 * \param feature   The string for the define to check (e.g. "AWRTC_MBEDTLS_AES_C")
 *

...
#ifndef AWRTC_MBEDTLS_DHM_H
#define AWRTC_MBEDTLS_DHM_H
...
#define AWRTC_MBEDTLS_ERR_DHM_BAD_INPUT_DATA                    -0x3080
/** Reading of the DHM parameters failed. */
#define AWRTC_MBEDTLS_ERR_DHM_READ_PARAMS_FAILED                -0x3100
/** Making of the DHM parameters failed. */
#define AWRTC_MBEDTLS_ERR_DHM_MAKE_PARAMS_FAILED                -0x3180
/** Reading of the public values failed. */
#define AWRTC_MBEDTLS_ERR_DHM_READ_PUBLIC_FAILED                -0x3200
/** Making of the public value failed. */
#define AWRTC_MBEDTLS_ERR_DHM_MAKE_PUBLIC_FAILED                -0x3280
/** Calculation of the DHM secret failed. */
#define AWRTC_MBEDTLS_ERR_DHM_CALC_SECRET_FAILED                -0x3300
/** The ASN.1 data is not formatted correctly. */
#define AWRTC_MBEDTLS_ERR_DHM_INVALID_FORMAT                    -0x3380
/** Allocation of memory failed. */
#define AWRTC_MBEDTLS_ERR_DHM_ALLOC_FAILED                      -0x3400
/** Read or write of file failed. */
#define AWRTC_MBEDTLS_ERR_DHM_FILE_IO_ERROR                     -0x3480
/** Setting the modulus and generator failed. */
#define AWRTC_MBEDTLS_ERR_DHM_SET_GROUP_FAILED                  -0x3580

/** Which parameter to access in awrtc_mbedtls_dhm_get_value(). */
typedef enum {
    AWRTC_MBEDTLS_DHM_PARAM_P,  /*!<  The prime modulus. */
    AWRTC_MBEDTLS_DHM_PARAM_G,  /*!<  The generator. */
    AWRTC_MBEDTLS_DHM_PARAM_X,  /*!<  Our secret value. */
    AWRTC_MBEDTLS_DHM_PARAM_GX, /*!<  Our public key = \c G^X mod \c P. */
    AWRTC_MBEDTLS_DHM_PARAM_GY, /*!<  The public key of the peer = \c G^Y mod \c P. */
    AWRTC_MBEDTLS_DHM_PARAM_K,  /*!<  The shared secret = \c G^(XY) mod \c P. */
} awrtc_mbedtls_dhm_parameter;
 ...
 */
typedef struct awrtc_mbedtls_dhm_context {
    awrtc_mbedtls_mpi AWRTC_MBEDTLS_PRIVATE(P);      /*!<  The prime modulus. */
    awrtc_mbedtls_mpi AWRTC_MBEDTLS_PRIVATE(G);      /*!<  The generator. */
    awrtc_mbedtls_mpi AWRTC_MBEDTLS_PRIVATE(X);      /*!<  Our secret value. */
    awrtc_mbedtls_mpi AWRTC_MBEDTLS_PRIVATE(GX);     /*!<  Our public key = \c G^X mod \c P. */
    awrtc_mbedtls_mpi AWRTC_MBEDTLS_PRIVATE(GY);     /*!<  The public key of the peer = \c G^Y mod \c P. */
    awrtc_mbedtls_mpi AWRTC_MBEDTLS_PRIVATE(K);      /*!<  The shared secret = \c G^(XY) mod \c P. */
    awrtc_mbedtls_mpi AWRTC_MBEDTLS_PRIVATE(RP);     /*!<  The cached value = \c R^2 mod \c P. */
    awrtc_mbedtls_mpi AWRTC_MBEDTLS_PRIVATE(Vi);     /*!<  The blinding value. */
    awrtc_mbedtls_mpi AWRTC_MBEDTLS_PRIVATE(Vf);     /*!<  The unblinding value. */
    awrtc_mbedtls_mpi AWRTC_MBEDTLS_PRIVATE(pX);     /*!<  The previous \c X. */
}
awrtc_mbedtls_dhm_context;

#else /* AWRTC_MBEDTLS_DHM_ALT */
#include "dhm_alt.h"
 ...
 * \return         An \c AWRTC_MBEDTLS_ERR_DHM_XXX error code on failure.
 */
 ...
 *                 awrtc_mbedtls_dhm_set_group() below in conjunction with
 *                 awrtc_mbedtls_mpi_read_binary() and awrtc_mbedtls_mpi_read_string().
 *
 ...
 *                 awrtc_mbedtls_mpi_size() to computing the byte-size of an MPI.
 ...
 *                 in preparation for awrtc_mbedtls_dhm_make_params().
 *
 ...
 *                 its DHM parameters set, e.g. via awrtc_mbedtls_dhm_set_group().
 ...
 *
 * \return         \c 0 on success.
 * \return         #AWRTC_MBEDTLS_ERR_DHM_BAD_INPUT_DATA if \p param is invalid.
 * \return         An \c AWRTC_MBEDTLS_ERR_MPI_XXX error code if the copy fails.
 */
 ...
 *
 * \return            \c 0 on success.
 * \return            An \c AWRTC_MBEDTLS_ERR_DHM_XXX or \c AWRTC_MBEDTLS_ERR_PEM_XXX error
 *                    code on failure.
 */
 ...
 *
 * \return         \c 0 on success.
 * \return         An \c AWRTC_MBEDTLS_ERR_DHM_XXX or \c AWRTC_MBEDTLS_ERR_PEM_XXX
 ...
 * through \c awrtc_mbedtls_ssl_conf_dh_param.
 *
...
#define AWRTC_MBEDTLS_DHM_RFC3526_MODP_2048_P_BIN {        \
...
#define AWRTC_MBEDTLS_DHM_RFC3526_MODP_2048_G_BIN { 0x02 }

#define AWRTC_MBEDTLS_DHM_RFC3526_MODP_3072_P_BIN {       \
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, \
        0xC9, 0x0F, 0xDA, 0xA2, 0x21, 0x68, 0xC2, 0x34, \
        0xC4, 0xC6, 0x62, 0x8B, 0x80, 0xDC, 0x1C, 0xD1, \
        0x29, 0x02, 0x4E, 0x08, 0x8A, 0x67, 0xCC, 0x74, \
...
#define AWRTC_MBEDTLS_DHM_RFC3526_MODP_3072_G_BIN { 0x02 }

#define AWRTC_MBEDTLS_DHM_RFC3526_MODP_4096_P_BIN  {       \
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,  \
        0xC9, 0x0F, 0xDA, 0xA2, 0x21, 0x68, 0xC2, 0x34,  \
        0xC4, 0xC6, 0x62, 0x8B, 0x80, 0xDC, 0x1C, 0xD1,  \
        0x29, 0x02, 0x4E, 0x08, 0x8A, 0x67, 0xCC, 0x74,  \
...
#define AWRTC_MBEDTLS_DHM_RFC3526_MODP_4096_G_BIN { 0x02 }

#define AWRTC_MBEDTLS_DHM_RFC7919_FFDHE2048_P_BIN {        \
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, \
...
#define AWRTC_MBEDTLS_DHM_RFC7919_FFDHE2048_G_BIN { 0x02 }

#define AWRTC_MBEDTLS_DHM_RFC7919_FFDHE3072_P_BIN { \
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, \
        0xAD, 0xF8, 0x54, 0x58, 0xA2, 0xBB, 0x4A, 0x9A, \
        0xAF, 0xDC, 0x56, 0x20, 0x27, 0x3D, 0x3C, 0xF1, \
        0xD8, 0xB9, 0xC5, 0x83, 0xCE, 0x2D, 0x36, 0x95, \
...
#define AWRTC_MBEDTLS_DHM_RFC7919_FFDHE3072_G_BIN { 0x02 }

#define AWRTC_MBEDTLS_DHM_RFC7919_FFDHE4096_P_BIN {        \
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, \
        0xAD, 0xF8, 0x54, 0x58, 0xA2, 0xBB, 0x4A, 0x9A, \
        0xAF, 0xDC, 0x56, 0x20, 0x27, 0x3D, 0x3C, 0xF1, \
        0xD8, 0xB9, 0xC5, 0x83, 0xCE, 0x2D, 0x36, 0x95, \
...
#define AWRTC_MBEDTLS_DHM_RFC7919_FFDHE4096_G_BIN { 0x02 }

#define AWRTC_MBEDTLS_DHM_RFC7919_FFDHE6144_P_BIN {        \
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, \
        0xAD, 0xF8, 0x54, 0x58, 0xA2, 0xBB, 0x4A, 0x9A, \
        0xAF, 0xDC, 0x56, 0x20, 0x27, 0x3D, 0x3C, 0xF1, \
        0xD8, 0xB9, 0xC5, 0x83, 0xCE, 0x2D, 0x36, 0x95, \
...
#define AWRTC_MBEDTLS_DHM_RFC7919_FFDHE6144_G_BIN { 0x02 }

#define AWRTC_MBEDTLS_DHM_RFC7919_FFDHE8192_P_BIN {        \
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, \
        0xAD, 0xF8, 0x54, 0x58, 0xA2, 0xBB, 0x4A, 0x9A, \
        0xAF, 0xDC, 0x56, 0x20, 0x27, 0x3D, 0x3C, 0xF1, \
        0xD8, 0xB9, 0xC5, 0x83, 0xCE, 0x2D, 0x36, 0x95, \
...
#define AWRTC_MBEDTLS_DHM_RFC7919_FFDHE8192_G_BIN { 0x02 }

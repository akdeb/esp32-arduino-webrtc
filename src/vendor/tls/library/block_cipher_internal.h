 ...
 */
#ifndef AWRTC_MBEDTLS_BLOCK_CIPHER_INTERNAL_H
#define AWRTC_MBEDTLS_BLOCK_CIPHER_INTERNAL_H

#include "../include/mbedtls/build_info.h"

#include "../include/mbedtls/cipher.h"

#include "../include/mbedtls/block_cipher.h"
 ...
 */
static inline void awrtc_mbedtls_block_cipher_init(awrtc_mbedtls_block_cipher_context_t *ctx)
{
 ...
 *                  This must be called after awrtc_mbedtls_block_cipher_init().
 *
 * \param ctx       The context to set up.
 * \param cipher_id The identifier of the cipher to use.
 *                  This must be either AES, ARIA or Camellia.
 *                  Warning: this is a ::awrtc_mbedtls_cipher_id_t,
 *                  not a ::awrtc_mbedtls_block_cipher_id_t!
 *
 * \retval          \c 0 on success.
 * \retval          #AWRTC_MBEDTLS_ERR_CIPHER_BAD_INPUT_DATA if \p cipher_id was
 *                  invalid.
 */
 ...
 *
 * \retval          \c 0 on success.
 * \retval          #AWRTC_MBEDTLS_ERR_CIPHER_INVALID_CONTEXT if the context was not
 *                  properly set up before calling this function.
 * \retval          One of #AWRTC_MBEDTLS_ERR_AES_INVALID_KEY_LENGTH,
 *                  #AWRTC_MBEDTLS_ERR_ARIA_BAD_INPUT_DATA,
 *                  #AWRTC_MBEDTLS_ERR_CAMELLIA_BAD_INPUT_DATA if \p key_bitlen is
 *                  invalid.
 */
...
#endif /* AWRTC_MBEDTLS_BLOCK_CIPHER_INTERNAL_H */

 ...
 */
#ifndef AWRTC_MBEDTLS_SSL_MISC_H
#define AWRTC_MBEDTLS_SSL_MISC_H
...
#define AWRTC_MBEDTLS_SSL_ECP_RESTARTABLE_ENABLED
#endif

#define AWRTC_MBEDTLS_SSL_INITIAL_HANDSHAKE           0
#define AWRTC_MBEDTLS_SSL_RENEGOTIATION_IN_PROGRESS   1   /* In progress */
#define AWRTC_MBEDTLS_SSL_RENEGOTIATION_DONE          2   /* Done or aborted */
#define AWRTC_MBEDTLS_SSL_RENEGOTIATION_PENDING       3   /* Requested (server only) */

/* Faked handshake message identity for HelloRetryRequest. */
#define AWRTC_MBEDTLS_SSL_TLS1_3_HS_HELLO_RETRY_REQUEST (-AWRTC_MBEDTLS_SSL_HS_SERVER_HELLO)

/*
 * Internal identity of handshake extensions
 */
#define AWRTC_MBEDTLS_SSL_EXT_ID_UNRECOGNIZED                0
#define AWRTC_MBEDTLS_SSL_EXT_ID_SERVERNAME                  1
#define AWRTC_MBEDTLS_SSL_EXT_ID_SERVERNAME_HOSTNAME         1
#define AWRTC_MBEDTLS_SSL_EXT_ID_MAX_FRAGMENT_LENGTH         2
#define AWRTC_MBEDTLS_SSL_EXT_ID_STATUS_REQUEST              3
#define AWRTC_MBEDTLS_SSL_EXT_ID_SUPPORTED_GROUPS            4
#define AWRTC_MBEDTLS_SSL_EXT_ID_SUPPORTED_ELLIPTIC_CURVES   4
#define AWRTC_MBEDTLS_SSL_EXT_ID_SIG_ALG                     5
#define AWRTC_MBEDTLS_SSL_EXT_ID_USE_SRTP                    6
#define AWRTC_MBEDTLS_SSL_EXT_ID_HEARTBEAT                   7
#define AWRTC_MBEDTLS_SSL_EXT_ID_ALPN                        8
#define AWRTC_MBEDTLS_SSL_EXT_ID_SCT                         9
#define AWRTC_MBEDTLS_SSL_EXT_ID_CLI_CERT_TYPE              10
#define AWRTC_MBEDTLS_SSL_EXT_ID_SERV_CERT_TYPE             11
#define AWRTC_MBEDTLS_SSL_EXT_ID_PADDING                    12
#define AWRTC_MBEDTLS_SSL_EXT_ID_PRE_SHARED_KEY             13
#define AWRTC_MBEDTLS_SSL_EXT_ID_EARLY_DATA                 14
#define AWRTC_MBEDTLS_SSL_EXT_ID_SUPPORTED_VERSIONS         15
#define AWRTC_MBEDTLS_SSL_EXT_ID_COOKIE                     16
#define AWRTC_MBEDTLS_SSL_EXT_ID_PSK_KEY_EXCHANGE_MODES     17
#define AWRTC_MBEDTLS_SSL_EXT_ID_CERT_AUTH                  18
#define AWRTC_MBEDTLS_SSL_EXT_ID_OID_FILTERS                19
#define AWRTC_MBEDTLS_SSL_EXT_ID_POST_HANDSHAKE_AUTH        20
#define AWRTC_MBEDTLS_SSL_EXT_ID_SIG_ALG_CERT               21
#define AWRTC_MBEDTLS_SSL_EXT_ID_KEY_SHARE                  22
#define AWRTC_MBEDTLS_SSL_EXT_ID_TRUNCATED_HMAC             23
#define AWRTC_MBEDTLS_SSL_EXT_ID_SUPPORTED_POINT_FORMATS    24
#define AWRTC_MBEDTLS_SSL_EXT_ID_ENCRYPT_THEN_MAC           25
#define AWRTC_MBEDTLS_SSL_EXT_ID_EXTENDED_MASTER_SECRET     26
#define AWRTC_MBEDTLS_SSL_EXT_ID_SESSION_TICKET             27
#define AWRTC_MBEDTLS_SSL_EXT_ID_RECORD_SIZE_LIMIT          28
...
#define AWRTC_MBEDTLS_SSL_EXT_MASK(id)       (1ULL << (AWRTC_MBEDTLS_SSL_EXT_ID_##id))
/* Reset value of extension mask */
#define AWRTC_MBEDTLS_SSL_EXT_MASK_NONE                                              0
...
#define AWRTC_MBEDTLS_SSL_TLS1_3_EXT_MASK_UNRECOGNIZED                               \
    (AWRTC_MBEDTLS_SSL_EXT_MASK(SUPPORTED_POINT_FORMATS)                | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(ENCRYPT_THEN_MAC)                       | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(EXTENDED_MASTER_SECRET)                 | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(SESSION_TICKET)                         | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(TRUNCATED_HMAC)                         | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(UNRECOGNIZED))

/* RFC 8446 section 4.2. Allowed extensions for ClientHello */
#define AWRTC_MBEDTLS_SSL_TLS1_3_ALLOWED_EXTS_OF_CH                                  \
    (AWRTC_MBEDTLS_SSL_EXT_MASK(SERVERNAME)                             | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(MAX_FRAGMENT_LENGTH)                    | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(STATUS_REQUEST)                         | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(SUPPORTED_GROUPS)                       | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(SIG_ALG)                                | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(USE_SRTP)                               | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(HEARTBEAT)                              | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(ALPN)                                   | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(SCT)                                    | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(CLI_CERT_TYPE)                          | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(SERV_CERT_TYPE)                         | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(PADDING)                                | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(KEY_SHARE)                              | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(PRE_SHARED_KEY)                         | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(PSK_KEY_EXCHANGE_MODES)                 | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(EARLY_DATA)                             | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(COOKIE)                                 | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(SUPPORTED_VERSIONS)                     | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(CERT_AUTH)                              | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(POST_HANDSHAKE_AUTH)                    | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(SIG_ALG_CERT)                           | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(RECORD_SIZE_LIMIT)                      | \
     AWRTC_MBEDTLS_SSL_TLS1_3_EXT_MASK_UNRECOGNIZED)

/* RFC 8446 section 4.2. Allowed extensions for EncryptedExtensions */
#define AWRTC_MBEDTLS_SSL_TLS1_3_ALLOWED_EXTS_OF_EE                                  \
    (AWRTC_MBEDTLS_SSL_EXT_MASK(SERVERNAME)                             | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(MAX_FRAGMENT_LENGTH)                    | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(SUPPORTED_GROUPS)                       | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(USE_SRTP)                               | \
...
#define AWRTC_MBEDTLS_SSL_TLS1_3_ALLOWED_EXTS_OF_CR                                  \
    (AWRTC_MBEDTLS_SSL_EXT_MASK(STATUS_REQUEST)                         | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(SIG_ALG)                                | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(SCT)                                    | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(CERT_AUTH)                              | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(OID_FILTERS)                            | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(SIG_ALG_CERT)                           | \
     AWRTC_MBEDTLS_SSL_TLS1_3_EXT_MASK_UNRECOGNIZED)

/* RFC 8446 section 4.2. Allowed extensions for Certificate */
#define AWRTC_MBEDTLS_SSL_TLS1_3_ALLOWED_EXTS_OF_CT                                  \
    (AWRTC_MBEDTLS_SSL_EXT_MASK(STATUS_REQUEST)                         | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(SCT))

/* RFC 8446 section 4.2. Allowed extensions for ServerHello */
#define AWRTC_MBEDTLS_SSL_TLS1_3_ALLOWED_EXTS_OF_SH                                  \
    (AWRTC_MBEDTLS_SSL_EXT_MASK(KEY_SHARE)                              | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(PRE_SHARED_KEY)                         | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(SUPPORTED_VERSIONS))

/* RFC 8446 section 4.2. Allowed extensions for HelloRetryRequest */
#define AWRTC_MBEDTLS_SSL_TLS1_3_ALLOWED_EXTS_OF_HRR                                 \
    (AWRTC_MBEDTLS_SSL_EXT_MASK(KEY_SHARE)                              | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(COOKIE)                                 | \
     AWRTC_MBEDTLS_SSL_EXT_MASK(SUPPORTED_VERSIONS))

/* RFC 8446 section 4.2. Allowed extensions for NewSessionTicket */
#define AWRTC_MBEDTLS_SSL_TLS1_3_ALLOWED_EXTS_OF_NST                                 \
    (AWRTC_MBEDTLS_SSL_EXT_MASK(EARLY_DATA)                             | \
     AWRTC_MBEDTLS_SSL_TLS1_3_EXT_MASK_UNRECOGNIZED)
 ...
 */
#define AWRTC_MBEDTLS_SSL_PROC_CHK(f)                               \
    do {                                                        \
        ret = (f);                                            \
        if (ret != 0)                                          \
        {                                                       \
 ...
 */
#define AWRTC_MBEDTLS_SSL_PROC_CHK_NEG(f)                           \
    do {                                                        \
        ret = (f);                                            \
        if (ret < 0)                                           \
        {                                                       \
 ...
 */
#define AWRTC_MBEDTLS_SSL_RETRANS_PREPARING       0
#define AWRTC_MBEDTLS_SSL_RETRANS_SENDING         1
#define AWRTC_MBEDTLS_SSL_RETRANS_WAITING         2
#define AWRTC_MBEDTLS_SSL_RETRANS_FINISHED        3
...
/* This macro determines whether CBC is supported. */
    ...
    (defined(AWRTC_MBEDTLS_SSL_HAVE_AES)     ||                                  \
    defined(AWRTC_MBEDTLS_SSL_HAVE_CAMELLIA) ||                                  \
    defined(AWRTC_MBEDTLS_SSL_HAVE_ARIA))
#define AWRTC_MBEDTLS_SSL_SOME_SUITES_USE_CBC
#endif

/* This macro determines whether a ciphersuite using a
 * stream cipher can be used. */
#if defined(AWRTC_MBEDTLS_CIPHER_NULL_CIPHER)
#define AWRTC_MBEDTLS_SSL_SOME_SUITES_USE_STREAM
#endif
...
/* This macro determines whether the CBC construct used in TLS 1.2 is supported. */
    ...
    defined(AWRTC_MBEDTLS_SSL_PROTO_TLS1_2)
#define AWRTC_MBEDTLS_SSL_SOME_SUITES_USE_TLS_CBC
#endif

#if defined(AWRTC_MBEDTLS_SSL_SOME_SUITES_USE_STREAM) || \
    defined(AWRTC_MBEDTLS_SSL_SOME_SUITES_USE_CBC)
#define AWRTC_MBEDTLS_SSL_SOME_SUITES_USE_MAC
#endif

/* This macro determines whether a ciphersuite uses Encrypt-then-MAC with CBC */
#if defined(AWRTC_MBEDTLS_SSL_SOME_SUITES_USE_CBC) && \
    defined(AWRTC_MBEDTLS_SSL_ENCRYPT_THEN_MAC)
#define AWRTC_MBEDTLS_SSL_SOME_SUITES_USE_CBC_ETM
#endif
...
#define AWRTC_MBEDTLS_SSL_MAC_ADD                 48  /* SHA-384 used for HMAC */
#elif defined(AWRTC_MBEDTLS_MD_CAN_SHA256)
#define AWRTC_MBEDTLS_SSL_MAC_ADD                 32  /* SHA-256 used for HMAC */
#else
#define AWRTC_MBEDTLS_SSL_MAC_ADD                 20  /* SHA-1   used for HMAC */
#endif
#else /* AWRTC_MBEDTLS_SSL_SOME_SUITES_USE_MAC */
/* AEAD ciphersuites: GCM and CCM use a 128 bits tag */
#define AWRTC_MBEDTLS_SSL_MAC_ADD                 16
#endif

#if defined(AWRTC_MBEDTLS_SSL_HAVE_CBC)
#define AWRTC_MBEDTLS_SSL_PADDING_ADD            256
#else
#define AWRTC_MBEDTLS_SSL_PADDING_ADD              0
#endif

#if defined(AWRTC_MBEDTLS_SSL_DTLS_CONNECTION_ID)
#define AWRTC_MBEDTLS_SSL_MAX_CID_EXPANSION      AWRTC_MBEDTLS_SSL_CID_TLS1_3_PADDING_GRANULARITY
#else
#define AWRTC_MBEDTLS_SSL_MAX_CID_EXPANSION        0
#endif

#define AWRTC_MBEDTLS_SSL_PAYLOAD_OVERHEAD (AWRTC_MBEDTLS_MAX_IV_LENGTH +          \
                                      AWRTC_MBEDTLS_SSL_MAC_ADD +            \
                                      AWRTC_MBEDTLS_SSL_PADDING_ADD +        \
                                      AWRTC_MBEDTLS_SSL_MAX_CID_EXPANSION    \
                                      )

#define AWRTC_MBEDTLS_SSL_IN_PAYLOAD_LEN (AWRTC_MBEDTLS_SSL_PAYLOAD_OVERHEAD + \
                                    (AWRTC_MBEDTLS_SSL_IN_CONTENT_LEN))

#define AWRTC_MBEDTLS_SSL_OUT_PAYLOAD_LEN (AWRTC_MBEDTLS_SSL_PAYLOAD_OVERHEAD + \
                                     (AWRTC_MBEDTLS_SSL_OUT_CONTENT_LEN))

/* The maximum number of buffered handshake messages. */
#define AWRTC_MBEDTLS_SSL_MAX_BUFFERED_HS 4

/* Maximum length we can advertise as our max content length for
   RFC 6066 max_fragment_length extension negotiation purposes
   (the lesser of both sizes, if they are unequal.)
 */
#define AWRTC_MBEDTLS_TLS_EXT_ADV_CONTENT_LEN (                            \
        (AWRTC_MBEDTLS_SSL_IN_CONTENT_LEN > AWRTC_MBEDTLS_SSL_OUT_CONTENT_LEN)   \
        ? (AWRTC_MBEDTLS_SSL_OUT_CONTENT_LEN)                            \
        : (AWRTC_MBEDTLS_SSL_IN_CONTENT_LEN)                             \
        )

/* Maximum size in bytes of list in signature algorithms ext., RFC 5246/8446 */
#define AWRTC_MBEDTLS_SSL_MAX_SIG_ALG_LIST_LEN       65534

/* Minimum size in bytes of list in signature algorithms ext., RFC 5246/8446 */
#define AWRTC_MBEDTLS_SSL_MIN_SIG_ALG_LIST_LEN       2

/* Maximum size in bytes of list in supported elliptic curve ext., RFC 4492 */
#define AWRTC_MBEDTLS_SSL_MAX_CURVE_LIST_LEN         65535

#define AWRTC_MBEDTLS_RECEIVED_SIG_ALGS_SIZE         20

#if defined(AWRTC_MBEDTLS_SSL_HANDSHAKE_WITH_CERT_ENABLED)

#define AWRTC_MBEDTLS_TLS_SIG_NONE AWRTC_MBEDTLS_TLS1_3_SIG_NONE

#if defined(AWRTC_MBEDTLS_SSL_PROTO_TLS1_2)
#define AWRTC_MBEDTLS_SSL_TLS12_SIG_AND_HASH_ALG(sig, hash) ((hash << 8) | sig)
#define AWRTC_MBEDTLS_SSL_TLS12_SIG_ALG_FROM_SIG_AND_HASH_ALG(alg) (alg & 0xFF)
#define AWRTC_MBEDTLS_SSL_TLS12_HASH_ALG_FROM_SIG_AND_HASH_ALG(alg) (alg >> 8)
#endif /* AWRTC_MBEDTLS_SSL_PROTO_TLS1_2 */
...
#if AWRTC_MBEDTLS_SSL_IN_CONTENT_LEN > 16384
#error "Bad configuration - incoming record content too large."
#endif

#if AWRTC_MBEDTLS_SSL_OUT_CONTENT_LEN > 16384
#error "Bad configuration - outgoing record content too large."
#endif

#if AWRTC_MBEDTLS_SSL_IN_PAYLOAD_LEN > AWRTC_MBEDTLS_SSL_IN_CONTENT_LEN + 2048
#error "Bad configuration - incoming protected record payload too large."
#endif

#if AWRTC_MBEDTLS_SSL_OUT_PAYLOAD_LEN > AWRTC_MBEDTLS_SSL_OUT_CONTENT_LEN + 2048
...
#define AWRTC_MBEDTLS_SSL_HEADER_LEN 13

#if !defined(AWRTC_MBEDTLS_SSL_DTLS_CONNECTION_ID)
#define AWRTC_MBEDTLS_SSL_IN_BUFFER_LEN  \
    ((AWRTC_MBEDTLS_SSL_HEADER_LEN) + (AWRTC_MBEDTLS_SSL_IN_PAYLOAD_LEN))
#else
#define AWRTC_MBEDTLS_SSL_IN_BUFFER_LEN  \
    ((AWRTC_MBEDTLS_SSL_HEADER_LEN) + (AWRTC_MBEDTLS_SSL_IN_PAYLOAD_LEN) \
     + (AWRTC_MBEDTLS_SSL_CID_IN_LEN_MAX))
#endif

#if !defined(AWRTC_MBEDTLS_SSL_DTLS_CONNECTION_ID)
#define AWRTC_MBEDTLS_SSL_OUT_BUFFER_LEN  \
    ((AWRTC_MBEDTLS_SSL_HEADER_LEN) + (AWRTC_MBEDTLS_SSL_OUT_PAYLOAD_LEN))
#else
#define AWRTC_MBEDTLS_SSL_OUT_BUFFER_LEN                               \
    ((AWRTC_MBEDTLS_SSL_HEADER_LEN) + (AWRTC_MBEDTLS_SSL_OUT_PAYLOAD_LEN)    \
     + (AWRTC_MBEDTLS_SSL_CID_OUT_LEN_MAX))
#endif

#define AWRTC_MBEDTLS_CLIENT_HELLO_RANDOM_LEN 32
#define AWRTC_MBEDTLS_SERVER_HELLO_RANDOM_LEN 32
 ...
 *
 * \sa             awrtc_mbedtls_ssl_conf_max_frag_len()
 ...
 *                 length, or, if there is none, AWRTC_MBEDTLS_SSL_IN_CONTENT_LEN.
 *                 If it is not defined either, the value is 2^14. This function
 *                 works as its predecessor, \c awrtc_mbedtls_ssl_get_max_frag_len().
 *
 * \sa             awrtc_mbedtls_ssl_conf_max_frag_len()
...
static inline size_t awrtc_mbedtls_ssl_get_output_buflen(const awrtc_mbedtls_ssl_context *ctx)
{
#if defined(AWRTC_MBEDTLS_SSL_DTLS_CONNECTION_ID)
    return awrtc_mbedtls_ssl_get_output_max_frag_len(ctx)
           + AWRTC_MBEDTLS_SSL_HEADER_LEN + AWRTC_MBEDTLS_SSL_PAYLOAD_OVERHEAD
           + AWRTC_MBEDTLS_SSL_CID_OUT_LEN_MAX;
#else
    return awrtc_mbedtls_ssl_get_output_max_frag_len(ctx)
           + AWRTC_MBEDTLS_SSL_HEADER_LEN + AWRTC_MBEDTLS_SSL_PAYLOAD_OVERHEAD;
...
static inline size_t awrtc_mbedtls_ssl_get_input_buflen(const awrtc_mbedtls_ssl_context *ctx)
{
#if defined(AWRTC_MBEDTLS_SSL_DTLS_CONNECTION_ID)
    return awrtc_mbedtls_ssl_get_input_max_frag_len(ctx)
           + AWRTC_MBEDTLS_SSL_HEADER_LEN + AWRTC_MBEDTLS_SSL_PAYLOAD_OVERHEAD
           + AWRTC_MBEDTLS_SSL_CID_IN_LEN_MAX;
#else
    return awrtc_mbedtls_ssl_get_input_max_frag_len(ctx)
 ...
 */
#define AWRTC_MBEDTLS_TLS_EXT_SUPPORTED_POINT_FORMATS_PRESENT (1 << 0)
#define AWRTC_MBEDTLS_TLS_EXT_ECJPAKE_KKPP_OK                 (1 << 1)
...
static inline int awrtc_mbedtls_ssl_chk_buf_ptr(const uint8_t *cur,
...
typedef struct {
    ...
    const uint8_t *end;
    size_t need;
} awrtc_mbedtls_ssl_chk_buf_ptr_args;
                                          ...
                                          const uint8_t *end, size_t need)
{
    if ((cur > end) || (need > (size_t) (end - cur))) {
        awrtc_mbedtls_ssl_set_chk_buf_ptr_fail_args(cur, end, need);
        return 1;
    }
    return 0;
}
 ...
 *
 */
#define AWRTC_MBEDTLS_SSL_CHK_BUF_PTR(cur, end, need)                        \
    do {                                                                 \
        if (awrtc_mbedtls_ssl_chk_buf_ptr((cur), (end), (need)) != 0) \
        {                                                                \
 ...
 *               returns #AWRTC_MBEDTLS_ERR_SSL_DECODE_ERROR error and pends a
 *               #AWRTC_MBEDTLS_SSL_ALERT_MSG_DECODE_ERROR alert message.
 *
 ...
 *
 */
#define AWRTC_MBEDTLS_SSL_CHK_BUF_READ_PTR(cur, end, need)                          \
    do {                                                                        \
        if (awrtc_mbedtls_ssl_chk_buf_ptr((cur), (end), (need)) != 0)        \
        {                                                                       \
...
typedef int  awrtc_mbedtls_ssl_tls_prf_cb(const unsigned char *secret, size_t slen,
                                    const char *label,
 ...
 *
 * Since the current definitions of AWRTC_MBEDTLS_MAX_{KEY|BLOCK|IV}_LENGTH
...
#define AWRTC_MBEDTLS_SSL_MAX_BLOCK_LENGTH 16
#define AWRTC_MBEDTLS_SSL_MAX_IV_LENGTH    16
#define AWRTC_MBEDTLS_SSL_MAX_KEY_LENGTH   32

/**
 * \brief   The data structure holding the cryptographic material (key and IV)
 *          used for record protection in TLS 1.3.
 */
struct awrtc_mbedtls_ssl_key_set {
    /*! The key for client->server records. */
    unsigned char client_write_key[AWRTC_MBEDTLS_SSL_MAX_KEY_LENGTH];
    /*! The key for server->client records. */
    unsigned char server_write_key[AWRTC_MBEDTLS_SSL_MAX_KEY_LENGTH];
    /*! The IV  for client->server records. */
    unsigned char client_write_iv[AWRTC_MBEDTLS_SSL_MAX_IV_LENGTH];
    /*! The IV  for server->client records. */
    unsigned char server_write_iv[AWRTC_MBEDTLS_SSL_MAX_IV_LENGTH];
...
typedef struct awrtc_mbedtls_ssl_key_set awrtc_mbedtls_ssl_key_set;

typedef struct {
    unsigned char binder_key[AWRTC_MBEDTLS_TLS1_3_MD_MAX_SIZE];
    unsigned char client_early_traffic_secret[AWRTC_MBEDTLS_TLS1_3_MD_MAX_SIZE];
    unsigned char early_exporter_master_secret[AWRTC_MBEDTLS_TLS1_3_MD_MAX_SIZE];
} awrtc_mbedtls_ssl_tls13_early_secrets;

typedef struct {
    unsigned char client_handshake_traffic_secret[AWRTC_MBEDTLS_TLS1_3_MD_MAX_SIZE];
    unsigned char server_handshake_traffic_secret[AWRTC_MBEDTLS_TLS1_3_MD_MAX_SIZE];
} awrtc_mbedtls_ssl_tls13_handshake_secrets;

/*
 * This structure contains the parameters only needed during handshake.
 */
struct awrtc_mbedtls_ssl_handshake_params {
    ...
    awrtc_mbedtls_x509_crt *ecrs_peer_cert;   /*!< The peer's CRT chain.          */
    size_t ecrs_n;                      /*!< place for saving a length      */
#endif

    awrtc_mbedtls_ssl_ciphersuite_t const *ciphersuite_info;

    AWRTC_MBEDTLS_CHECK_RETURN_CRITICAL
    int (*update_checksum)(awrtc_mbedtls_ssl_context *, const unsigned char *, size_t);
    AWRTC_MBEDTLS_CHECK_RETURN_CRITICAL
    int (*calc_verify)(const awrtc_mbedtls_ssl_context *, unsigned char *, size_t *);
    AWRTC_MBEDTLS_CHECK_RETURN_CRITICAL
    int (*calc_finished)(awrtc_mbedtls_ssl_context *, unsigned char *, int);
    awrtc_mbedtls_ssl_tls_prf_cb *tls_prf;
...
#if defined(AWRTC_MBEDTLS_SSL_HANDSHAKE_WITH_CERT_ENABLED)
    uint16_t received_sig_algs[AWRTC_MBEDTLS_RECEIVED_SIG_ALGS_SIZE];
#endif
    ...
    awrtc_mbedtls_dhm_context dhm_ctx;                /*!<  DHM key exchange        */
#endif

#if !defined(AWRTC_MBEDTLS_USE_PSA_CRYPTO) && \
    defined(AWRTC_MBEDTLS_KEY_EXCHANGE_SOME_ECDH_OR_ECDHE_1_2_ENABLED)
    awrtc_mbedtls_ecdh_context ecdh_ctx;              /*!<  ECDH key exchange       */
#endif /* !AWRTC_MBEDTLS_USE_PSA_CRYPTO &&
          AWRTC_MBEDTLS_KEY_EXCHANGE_SOME_ECDH_OR_ECDHE_1_2_ENABLED */

#if defined(AWRTC_MBEDTLS_KEY_EXCHANGE_SOME_XXDH_PSA_ANY_ENABLED)
    awrtc_psa_key_type_t xxdh_psa_type;
    size_t xxdh_psa_bits;
    awrtc_mbedtls_svc_key_id_t xxdh_psa_privkey;
    uint8_t xxdh_psa_privkey_is_external;
    unsigned char xxdh_psa_peerkey[AWRTC_PSA_EXPORT_PUBLIC_KEY_MAX_SIZE];
    size_t xxdh_psa_peerkey_len;
#endif /* AWRTC_MBEDTLS_KEY_EXCHANGE_SOME_XXDH_PSA_ANY_ENABLED */

#if defined(AWRTC_MBEDTLS_KEY_EXCHANGE_ECJPAKE_ENABLED)
#if defined(AWRTC_MBEDTLS_USE_PSA_CRYPTO)
    awrtc_psa_pake_operation_t awrtc_psa_pake_ctx;        /*!< EC J-PAKE key exchange */
    awrtc_mbedtls_svc_key_id_t awrtc_psa_pake_password;
    uint8_t awrtc_psa_pake_ctx_is_ok;
#else
    awrtc_mbedtls_ecjpake_context ecjpake_ctx;        /*!< EC J-PAKE key exchange */
#endif /* AWRTC_MBEDTLS_USE_PSA_CRYPTO */
#if defined(AWRTC_MBEDTLS_SSL_CLI_C)
    ...
    defined(AWRTC_MBEDTLS_KEY_EXCHANGE_ECDSA_CERT_REQ_ANY_ALLOWED_ENABLED) || \
...
#if defined(AWRTC_MBEDTLS_USE_PSA_CRYPTO)
    awrtc_mbedtls_svc_key_id_t psk_opaque;            /*!< Opaque PSK from the callback   */
...
#if defined(AWRTC_MBEDTLS_SSL_ECP_RESTARTABLE_ENABLED)
    awrtc_mbedtls_x509_crt_restart_ctx ecrs_ctx;  /*!< restart context            */
#endif

#if defined(AWRTC_MBEDTLS_X509_CRT_PARSE_C)
    awrtc_mbedtls_ssl_key_cert *key_cert;     /*!< chosen key/cert pair (server)  */
#if defined(AWRTC_MBEDTLS_SSL_SERVER_NAME_INDICATION)
    awrtc_mbedtls_ssl_key_cert *sni_key_cert; /*!< key/cert list from SNI         */
    awrtc_mbedtls_x509_crt *sni_ca_chain;     /*!< trusted CAs from SNI callback  */
    awrtc_mbedtls_x509_crl *sni_ca_crl;       /*!< trusted CAs CRLs from SNI      */
    ...
    awrtc_mbedtls_pk_context peer_pubkey;     /*!< The public key from the peer.  */
    ...
    struct {
        ...
        struct awrtc_mbedtls_ssl_hs_buffer {
            unsigned is_valid      : 1;
            unsigned is_fragmented : 1;
            unsigned is_complete   : 1;
            unsigned char *data;
            size_t data_len;
        } hs[AWRTC_MBEDTLS_SSL_MAX_BUFFERED_HS];
    ...
    uint16_t cookie_len;                /*!< DTLS: HelloVerifyRequest cookie length
          ...
          ( AWRTC_MBEDTLS_SSL_PROTO_DTLS ||
            AWRTC_MBEDTLS_SSL_PROTO_TLS1_3 ) */
#if defined(AWRTC_MBEDTLS_SSL_SRV_C) && defined(AWRTC_MBEDTLS_SSL_PROTO_DTLS)
    unsigned char cookie_verify_result; /*!< Srv: flag for sending a cookie */
#endif /* AWRTC_MBEDTLS_SSL_SRV_C && AWRTC_MBEDTLS_SSL_PROTO_DTLS */
    ...
    awrtc_mbedtls_ssl_flight_item *flight;    /*!<  Current outgoing flight        */
    awrtc_mbedtls_ssl_flight_item *cur_msg;   /*!<  Current message in flight      */
    unsigned char *cur_msg_p;           /*!<  Position in current message    */
    unsigned int in_flight_start_seq;   /*!<  Minimum message sequence in the
                                              flight being received          */
    awrtc_mbedtls_ssl_transform *alt_transform_out;   /*!<  Alternative transform for
                                                   resending messages             */
    unsigned char alt_out_ctr[AWRTC_MBEDTLS_SSL_SEQUENCE_NUMBER_LEN]; /*!<  Alternative record epoch/counter
    ...
    uint8_t cid_in_use; /*!< This indicates whether the use of the CID extension
                         ...
                         *   #AWRTC_MBEDTLS_SSL_CID_ENABLED and
                         *   #AWRTC_MBEDTLS_SSL_CID_DISABLED. */
    unsigned char peer_cid[AWRTC_MBEDTLS_SSL_CID_OUT_LEN_MAX];   /*! The peer's CID */
...
#if defined(AWRTC_MBEDTLS_MD_CAN_SHA256)
#if defined(AWRTC_MBEDTLS_USE_PSA_CRYPTO)
    awrtc_psa_hash_operation_t fin_sha256_psa;
#else
    awrtc_mbedtls_md_context_t fin_sha256;
#endif
#endif
#if defined(AWRTC_MBEDTLS_MD_CAN_SHA384)
#if defined(AWRTC_MBEDTLS_USE_PSA_CRYPTO)
    awrtc_psa_hash_operation_t fin_sha384_psa;
#else
    awrtc_mbedtls_md_context_t fin_sha384;
#endif
#endif
    ...
    union {
        ...
        struct {
            ...
            unsigned char digest[AWRTC_MBEDTLS_TLS1_3_MD_MAX_SIZE];
            size_t digest_len;
        } finished_out;
    ...
    unsigned char randbytes[AWRTC_MBEDTLS_CLIENT_HELLO_RANDOM_LEN +
                            AWRTC_MBEDTLS_SERVER_HELLO_RANDOM_LEN];
    /*!<  random bytes            */
#if defined(AWRTC_MBEDTLS_SSL_PROTO_TLS1_2)
    unsigned char premaster[AWRTC_MBEDTLS_PREMASTER_SIZE];
    /*!<  premaster secret        */
    ...
    awrtc_mbedtls_ssl_transform *transform_handshake;
    union {
        unsigned char early[AWRTC_MBEDTLS_TLS1_3_MD_MAX_SIZE];
        unsigned char handshake[AWRTC_MBEDTLS_TLS1_3_MD_MAX_SIZE];
        unsigned char app[AWRTC_MBEDTLS_TLS1_3_MD_MAX_SIZE];
    ...
    awrtc_mbedtls_ssl_transform *transform_earlydata;
#endif
#endif /* AWRTC_MBEDTLS_SSL_PROTO_TLS1_3 */

#if defined(AWRTC_MBEDTLS_SSL_ASYNC_PRIVATE)
    /** Asynchronous operation context. This field is meant for use by the
     * asynchronous operation callbacks (awrtc_mbedtls_ssl_config::f_async_sign_start,
     * awrtc_mbedtls_ssl_config::f_async_decrypt_start,
     * awrtc_mbedtls_ssl_config::f_async_resume, awrtc_mbedtls_ssl_config::f_async_cancel).
    ...
    const awrtc_mbedtls_x509_crt *dn_hints;   /*!< acceptable client cert issuers */
#endif
#endif /* AWRTC_MBEDTLS_SSL_SERVER_NAME_INDICATION */
};

typedef struct awrtc_mbedtls_ssl_hs_buffer awrtc_mbedtls_ssl_hs_buffer;
 ...
 *   the type is AWRTC_MBEDTLS_CIPHER_AES_256_CBC resp. AWRTC_MBEDTLS_CIPHER_AES_192_GCM
 ...
 *
 */
struct awrtc_mbedtls_ssl_transform {
    /*
...
#if defined(AWRTC_MBEDTLS_USE_PSA_CRYPTO)
    awrtc_mbedtls_svc_key_id_t awrtc_psa_mac_enc;           /*!<  MAC (encryption)        */
    awrtc_mbedtls_svc_key_id_t awrtc_psa_mac_dec;           /*!<  MAC (decryption)        */
    awrtc_psa_algorithm_t awrtc_psa_mac_alg;                /*!<  psa MAC algorithm       */
#else
    awrtc_mbedtls_md_context_t md_ctx_enc;            /*!<  MAC (encryption)        */
    awrtc_mbedtls_md_context_t md_ctx_dec;            /*!<  MAC (decryption)        */
#endif /* AWRTC_MBEDTLS_USE_PSA_CRYPTO */
...
#if defined(AWRTC_MBEDTLS_USE_PSA_CRYPTO)
    awrtc_mbedtls_svc_key_id_t awrtc_psa_key_enc;           /*!<  psa encryption key      */
    awrtc_mbedtls_svc_key_id_t awrtc_psa_key_dec;           /*!<  psa decryption key      */
    awrtc_psa_algorithm_t awrtc_psa_alg;                    /*!<  psa algorithm           */
#else
    awrtc_mbedtls_cipher_context_t cipher_ctx_enc;    /*!<  encryption context      */
    awrtc_mbedtls_cipher_context_t cipher_ctx_dec;    /*!<  decryption context      */
#endif /* AWRTC_MBEDTLS_USE_PSA_CRYPTO */

#if defined(AWRTC_MBEDTLS_SSL_DTLS_CONNECTION_ID)
    uint8_t in_cid_len;
    uint8_t out_cid_len;
    unsigned char in_cid[AWRTC_MBEDTLS_SSL_CID_IN_LEN_MAX];
    unsigned char out_cid[AWRTC_MBEDTLS_SSL_CID_OUT_LEN_MAX];
#endif /* AWRTC_MBEDTLS_SSL_DTLS_CONNECTION_ID */
    ...
    unsigned char randbytes[AWRTC_MBEDTLS_SERVER_HELLO_RANDOM_LEN +
                            AWRTC_MBEDTLS_CLIENT_HELLO_RANDOM_LEN];
    /*!< ServerHello.random+ClientHello.random */
#endif /* defined(AWRTC_MBEDTLS_SSL_KEEP_RANDBYTES) */
};
 ...
 */
static inline int awrtc_mbedtls_ssl_transform_uses_aead(
 ...
 *
 */
#if AWRTC_MBEDTLS_SSL_CID_OUT_LEN_MAX > AWRTC_MBEDTLS_SSL_CID_IN_LEN_MAX
#define AWRTC_MBEDTLS_SSL_CID_LEN_MAX AWRTC_MBEDTLS_SSL_CID_OUT_LEN_MAX
#else
#define AWRTC_MBEDTLS_SSL_CID_LEN_MAX AWRTC_MBEDTLS_SSL_CID_IN_LEN_MAX
#endif

typedef struct {
    uint8_t ctr[AWRTC_MBEDTLS_SSL_SEQUENCE_NUMBER_LEN];  /* In TLS:  The implicit record sequence number.
    ...
    uint8_t ver[2];         /* SSL/TLS version as present on the wire.
                             ...
                             * using awrtc_mbedtls_ssl_read_version() and
                             * awrtc_mbedtls_ssl_write_version().
    ...
    unsigned char cid[AWRTC_MBEDTLS_SSL_CID_LEN_MAX];   /* The CID                 */
#endif /* AWRTC_MBEDTLS_SSL_DTLS_CONNECTION_ID */
} awrtc_mbedtls_record;

#if defined(AWRTC_MBEDTLS_X509_CRT_PARSE_C)
/*
 * List of certificate + private key pairs
 */
struct awrtc_mbedtls_ssl_key_cert {
    awrtc_mbedtls_x509_crt *cert;                 /*!< cert                       */
    awrtc_mbedtls_pk_context *key;                /*!< private key                */
    awrtc_mbedtls_ssl_key_cert *next;             /*!< next key/cert pair         */
};
#endif /* AWRTC_MBEDTLS_X509_CRT_PARSE_C */
 ...
 */
struct awrtc_mbedtls_ssl_flight_item {
    unsigned char *p;       /*!< message, including handshake headers   */
    size_t len;             /*!< length of p                            */
    unsigned char type;     /*!< type of the message: handshake or CCS  */
    awrtc_mbedtls_ssl_flight_item *next;  /*!< next handshake message(s)              */
};
#endif /* AWRTC_MBEDTLS_SSL_PROTO_DTLS */
 ...
 */
AWRTC_MBEDTLS_CHECK_RETURN_CRITICAL
int awrtc_mbedtls_ssl_tls12_write_client_hello_exts(awrtc_mbedtls_ssl_context *ssl,
                                              unsigned char *buf,
...
#endif /* AWRTC_MBEDTLS_SSL_PROTO_TLS1_2 &&
          AWRTC_MBEDTLS_KEY_EXCHANGE_WITH_CERT_ENABLED */
...
AWRTC_MBEDTLS_CHECK_RETURN_CRITICAL
int awrtc_mbedtls_ssl_handshake_client_step(awrtc_mbedtls_ssl_context *ssl);
AWRTC_MBEDTLS_CHECK_RETURN_CRITICAL
 ...
 */
const char *awrtc_mbedtls_ssl_states_str(awrtc_mbedtls_ssl_states state);
#endif

static inline void awrtc_mbedtls_ssl_handshake_set_state(awrtc_mbedtls_ssl_context *ssl,
                                                   awrtc_mbedtls_ssl_states state)
{
    AWRTC_MBEDTLS_SSL_DEBUG_MSG(3, ("handshake state: %d (%s) -> %d (%s)",
                              ssl->state, awrtc_mbedtls_ssl_states_str((awrtc_mbedtls_ssl_states) ssl->state),
                              (int) state, awrtc_mbedtls_ssl_states_str(state)));
    ssl->state = (int) state;
}

static inline void awrtc_mbedtls_ssl_handshake_increment_state(awrtc_mbedtls_ssl_context *ssl)
{
    awrtc_mbedtls_ssl_handshake_set_state(ssl, (awrtc_mbedtls_ssl_states) (ssl->state + 1));
}
 ...
 *
 *              a Updating
 *                [Currently implemented by awrtc_mbedtls_ssl_read_record]
 *
 ...
 *              application data reading function awrtc_mbedtls_ssl_read.
 *
 * \note        The above tries to give a conceptual picture of the
 *              record layer, but the current implementation deviates
 *              from it in some places. For example, our implementation of
 *              the update functionality through awrtc_mbedtls_ssl_read_record
...
int awrtc_mbedtls_ssl_write_handshake_msg_ext(awrtc_mbedtls_ssl_context *ssl,
                                        int update_checksum,
                                        int force_flush);
static inline int awrtc_mbedtls_ssl_write_handshake_msg(awrtc_mbedtls_ssl_context *ssl)
{
    return awrtc_mbedtls_ssl_write_handshake_msg_ext(ssl, 1 /* update checksum */, 1 /* force flush */);
}
...
#if !defined(AWRTC_MBEDTLS_USE_PSA_CRYPTO)
AWRTC_MBEDTLS_CHECK_RETURN_CRITICAL
int awrtc_mbedtls_ssl_psk_derive_premaster(awrtc_mbedtls_ssl_context *ssl,
                                     awrtc_mbedtls_key_exchange_type_t key_ex);
#endif /* !AWRTC_MBEDTLS_USE_PSA_CRYPTO */
#endif /* AWRTC_MBEDTLS_KEY_EXCHANGE_SOME_PSK_ENABLED */

#if defined(AWRTC_MBEDTLS_SSL_HANDSHAKE_WITH_PSK_ENABLED)
#if defined(AWRTC_MBEDTLS_SSL_CLI_C) || defined(AWRTC_MBEDTLS_SSL_SRV_C)
AWRTC_MBEDTLS_CHECK_RETURN_CRITICAL
 ...
 * 1. handshake PSK set by \c awrtc_mbedtls_ssl_set_hs_psk_opaque() in the PSK
 *    callback
 * 2. static PSK configured by \c awrtc_mbedtls_ssl_conf_psk_opaque()
 * Return an opaque PSK
 */
static inline awrtc_mbedtls_svc_key_id_t awrtc_mbedtls_ssl_get_opaque_psk(
    const awrtc_mbedtls_ssl_context *ssl)
{
    ...
    if (!awrtc_mbedtls_svc_key_id_is_null(ssl->conf->psk_opaque)) {
        return ssl->conf->psk_opaque;
    }

    return AWRTC_MBEDTLS_SVC_KEY_ID_INIT;
}
#else
/**
 * Get the first defined PSK by order of precedence:
 * 1. handshake PSK set by \c awrtc_mbedtls_ssl_set_hs_psk() in the PSK callback
 * 2. static PSK configured by \c awrtc_mbedtls_ssl_conf_psk()
 * Return a code and update the pair (PSK, PSK length) passed to this function
 */
static inline int awrtc_mbedtls_ssl_get_psk(const awrtc_mbedtls_ssl_context *ssl,
 ...
 * \param type      If the TLD ID is supported, then proper \c awrtc_psa_key_type_t
 *                  value is returned here. Can be NULL.
 * \param bits      If the TLD ID is supported, then proper bit size is returned
 *                  here. Can be NULL.
 * \return          AWRTC_PSA_SUCCESS if the TLS ID is supported,
 *                  AWRTC_PSA_ERROR_NOT_SUPPORTED otherwise
 *
...
/**
 * \brief Return \c awrtc_mbedtls_ecp_group_id for the specified TLS ID.
 *
 * \param tls_id    The TLS ID to look for
 * \return          Proper \c awrtc_mbedtls_ecp_group_id if the TLS ID is supported,
 *                  or AWRTC_MBEDTLS_ECP_DP_NONE otherwise
 */
awrtc_mbedtls_ecp_group_id awrtc_mbedtls_ssl_get_ecp_group_id_from_tls_id(uint16_t tls_id);

/**
 * \brief Return TLS ID for the specified \c awrtc_mbedtls_ecp_group_id.
 *
 * \param grp_id    The \c awrtc_mbedtls_ecp_group_id ID to look for
 * \return          Proper TLS ID if the \c awrtc_mbedtls_ecp_group_id is supported,
 *                  or 0 otherwise
 */
...
static inline awrtc_mbedtls_ssl_srtp_profile awrtc_mbedtls_ssl_check_srtp_profile_value
    (const uint16_t srtp_profile_value)
{
    ...
    return AWRTC_MBEDTLS_TLS_SRTP_UNSET;
}
#endif

#if defined(AWRTC_MBEDTLS_X509_CRT_PARSE_C)
static inline awrtc_mbedtls_pk_context *awrtc_mbedtls_ssl_own_key(awrtc_mbedtls_ssl_context *ssl)
{
    awrtc_mbedtls_ssl_key_cert *key_cert;
...
static inline awrtc_mbedtls_x509_crt *awrtc_mbedtls_ssl_own_cert(awrtc_mbedtls_ssl_context *ssl)
{
    awrtc_mbedtls_ssl_key_cert *key_cert;
 ...
 * [in] authmode: one of AWRTC_MBEDTLS_SSL_VERIFY_{NONE,OPTIONAL,REQUIRED}
 ...
 * - AWRTC_MBEDTLS_ERR_X509_CERT_VERIFY_FAILED or AWRTC_MBEDTLS_ERR_SSL_BAD_CERTIFICATE if
...
static inline size_t awrtc_mbedtls_ssl_in_hdr_len(const awrtc_mbedtls_ssl_context *ssl)
{
#if !defined(AWRTC_MBEDTLS_SSL_PROTO_DTLS)
    ((void) ssl);
#endif
...
static inline size_t awrtc_mbedtls_ssl_out_hdr_len(const awrtc_mbedtls_ssl_context *ssl)
{
    return (size_t) (ssl->out_iv - ssl->out_hdr);
}

static inline size_t awrtc_mbedtls_ssl_hs_hdr_len(const awrtc_mbedtls_ssl_context *ssl)
{
#if defined(AWRTC_MBEDTLS_SSL_PROTO_DTLS)
    if (ssl->conf->transport == AWRTC_MBEDTLS_SSL_TRANSPORT_DATAGRAM) {
        return 12;
...
#if defined(AWRTC_MBEDTLS_SSL_PROTO_TLS1_2)
/* The hash buffer must have at least AWRTC_MBEDTLS_MD_MAX_SIZE bytes of length. */
AWRTC_MBEDTLS_CHECK_RETURN_CRITICAL
...
static inline size_t awrtc_mbedtls_ssl_ep_len(const awrtc_mbedtls_ssl_context *ssl)
{
#if defined(AWRTC_MBEDTLS_SSL_PROTO_DTLS)
    if (ssl->conf->transport == AWRTC_MBEDTLS_SSL_TRANSPORT_DATAGRAM) {
        return 2;
...
/* Alias of awrtc_mbedtls_ssl_pend_fatal_alert */
#define AWRTC_MBEDTLS_SSL_PEND_FATAL_ALERT(type, user_return_value)         \
    awrtc_mbedtls_ssl_pend_fatal_alert(ssl, type, user_return_value)
...
#if defined(AWRTC_MBEDTLS_SSL_PROTO_TLS1_3)
static inline int awrtc_mbedtls_ssl_conf_is_tls13_only(const awrtc_mbedtls_ssl_config *conf)
{
    return conf->min_tls_version == AWRTC_MBEDTLS_SSL_VERSION_TLS1_3 &&
...
#if defined(AWRTC_MBEDTLS_SSL_PROTO_TLS1_2)
static inline int awrtc_mbedtls_ssl_conf_is_tls12_only(const awrtc_mbedtls_ssl_config *conf)
{
    return conf->min_tls_version == AWRTC_MBEDTLS_SSL_VERSION_TLS1_2 &&
           conf->max_tls_version == AWRTC_MBEDTLS_SSL_VERSION_TLS1_2;
}

#endif /* AWRTC_MBEDTLS_SSL_PROTO_TLS1_2 */

static inline int awrtc_mbedtls_ssl_conf_is_tls13_enabled(const awrtc_mbedtls_ssl_config *conf)
{
#if defined(AWRTC_MBEDTLS_SSL_PROTO_TLS1_3)
    return conf->min_tls_version <= AWRTC_MBEDTLS_SSL_VERSION_TLS1_3 &&
           conf->max_tls_version >= AWRTC_MBEDTLS_SSL_VERSION_TLS1_3;
...
static inline int awrtc_mbedtls_ssl_conf_is_tls12_enabled(const awrtc_mbedtls_ssl_config *conf)
{
#if defined(AWRTC_MBEDTLS_SSL_PROTO_TLS1_2)
    return conf->min_tls_version <= AWRTC_MBEDTLS_SSL_VERSION_TLS1_2 &&
           conf->max_tls_version >= AWRTC_MBEDTLS_SSL_VERSION_TLS1_2;
...
static inline int awrtc_mbedtls_ssl_conf_is_hybrid_tls12_tls13(const awrtc_mbedtls_ssl_config *conf)
{
    return conf->min_tls_version == AWRTC_MBEDTLS_SSL_VERSION_TLS1_2 &&
           conf->max_tls_version == AWRTC_MBEDTLS_SSL_VERSION_TLS1_3;
}
#endif /* AWRTC_MBEDTLS_SSL_PROTO_TLS1_2 && AWRTC_MBEDTLS_SSL_PROTO_TLS1_3 */
 ...
 * awrtc_psa_crypto_init(), since the TLS layer only supported TLS 1.2 and
 * did not use PSA crypto. (TLS 1.2 only uses PSA crypto if
 * AWRTC_MBEDTLS_USE_PSA_CRYPTO is enabled, which is not the case in the default
...
extern const uint8_t awrtc_mbedtls_ssl_tls13_hello_retry_request_magic[
    AWRTC_MBEDTLS_SERVER_HELLO_RANDOM_LEN];
AWRTC_MBEDTLS_CHECK_RETURN_CRITICAL
 ...
 */
AWRTC_MBEDTLS_CHECK_RETURN_CRITICAL
int awrtc_mbedtls_ssl_tls13_write_client_hello_exts(awrtc_mbedtls_ssl_context *ssl,
                                              unsigned char *buf,
                                              unsigned char *end,
                                              size_t *out_len);
 ...
 */
AWRTC_MBEDTLS_CHECK_RETURN_CRITICAL
int awrtc_mbedtls_ssl_tls13_handshake_client_step(awrtc_mbedtls_ssl_context *ssl);
 ...
 */
AWRTC_MBEDTLS_CHECK_RETURN_CRITICAL
int awrtc_mbedtls_ssl_tls13_handshake_server_step(awrtc_mbedtls_ssl_context *ssl);


/*
 * Helper functions around key exchange modes.
 */
static inline int awrtc_mbedtls_ssl_conf_tls13_is_kex_mode_enabled(awrtc_mbedtls_ssl_context *ssl,
                                                             int kex_mode_mask)
{
    return (ssl->conf->tls13_kex_modes & kex_mode_mask) != 0;
}

static inline int awrtc_mbedtls_ssl_conf_tls13_is_psk_enabled(awrtc_mbedtls_ssl_context *ssl)
{
    return awrtc_mbedtls_ssl_conf_tls13_is_kex_mode_enabled(ssl,
                                                      AWRTC_MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_PSK);
}

static inline int awrtc_mbedtls_ssl_conf_tls13_is_psk_ephemeral_enabled(awrtc_mbedtls_ssl_context *ssl)
{
    return awrtc_mbedtls_ssl_conf_tls13_is_kex_mode_enabled(ssl,
                                                      AWRTC_MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_PSK_EPHEMERAL);
}

static inline int awrtc_mbedtls_ssl_conf_tls13_is_ephemeral_enabled(awrtc_mbedtls_ssl_context *ssl)
{
    return awrtc_mbedtls_ssl_conf_tls13_is_kex_mode_enabled(ssl,
                                                      AWRTC_MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL);
}

static inline int awrtc_mbedtls_ssl_conf_tls13_is_some_ephemeral_enabled(awrtc_mbedtls_ssl_context *ssl)
{
    return awrtc_mbedtls_ssl_conf_tls13_is_kex_mode_enabled(ssl,
                                                      AWRTC_MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL_ALL);
}

static inline int awrtc_mbedtls_ssl_conf_tls13_is_some_psk_enabled(awrtc_mbedtls_ssl_context *ssl)
{
    return awrtc_mbedtls_ssl_conf_tls13_is_kex_mode_enabled(ssl,
 ...
 */
static inline int awrtc_mbedtls_ssl_tls13_is_kex_mode_supported(awrtc_mbedtls_ssl_context *ssl,
                                                          int kex_modes_mask)
{
    return (ssl->handshake->tls13_kex_modes & kex_modes_mask) != 0;
}

static inline int awrtc_mbedtls_ssl_tls13_is_psk_supported(awrtc_mbedtls_ssl_context *ssl)
{
    return awrtc_mbedtls_ssl_tls13_is_kex_mode_supported(ssl,
                                                   AWRTC_MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_PSK);
}

static inline int awrtc_mbedtls_ssl_tls13_is_psk_ephemeral_supported(
    awrtc_mbedtls_ssl_context *ssl)
{
    return awrtc_mbedtls_ssl_tls13_is_kex_mode_supported(ssl,
                                                   AWRTC_MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_PSK_EPHEMERAL);
...
static inline int awrtc_mbedtls_ssl_tls13_is_ephemeral_supported(awrtc_mbedtls_ssl_context *ssl)
{
    return awrtc_mbedtls_ssl_tls13_is_kex_mode_supported(ssl,
                                                   AWRTC_MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL);
}

static inline int awrtc_mbedtls_ssl_tls13_is_some_ephemeral_supported(awrtc_mbedtls_ssl_context *ssl)
{
    return awrtc_mbedtls_ssl_tls13_is_kex_mode_supported(ssl,
                                                   AWRTC_MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL_ALL);
}

static inline int awrtc_mbedtls_ssl_tls13_is_some_psk_supported(awrtc_mbedtls_ssl_context *ssl)
{
    return awrtc_mbedtls_ssl_tls13_is_kex_mode_supported(ssl,
                                                   AWRTC_MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_PSK_ALL);
}
#endif /* AWRTC_MBEDTLS_SSL_SRV_C &&
          AWRTC_MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_SOME_PSK_ENABLED */
...
static inline void awrtc_mbedtls_ssl_tls13_set_hs_sent_ext_mask(
    awrtc_mbedtls_ssl_context *ssl, unsigned int extension_type)
{
    ssl->handshake->sent_extensions |=
        awrtc_mbedtls_ssl_get_extension_mask(extension_type);
}

/*
 * Helper functions to check the selected key exchange mode.
 */
static inline int awrtc_mbedtls_ssl_tls13_key_exchange_mode_check(
    awrtc_mbedtls_ssl_context *ssl, int kex_mask)
{
    return (ssl->handshake->key_exchange_mode & kex_mask) != 0;
}

static inline int awrtc_mbedtls_ssl_tls13_key_exchange_mode_with_psk(
    awrtc_mbedtls_ssl_context *ssl)
{
    return awrtc_mbedtls_ssl_tls13_key_exchange_mode_check(ssl,
                                                     AWRTC_MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_PSK_ALL);
}

static inline int awrtc_mbedtls_ssl_tls13_key_exchange_mode_with_ephemeral(
    awrtc_mbedtls_ssl_context *ssl)
{
    return awrtc_mbedtls_ssl_tls13_key_exchange_mode_check(ssl,
                                                     AWRTC_MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL_ALL);
 ...
 */
    AWRTC_MBEDTLS_SSL_EARLY_DATA_STATE_IDLE,

/*
 * In its ClientHello, the client has not included an early data indication
 * extension.
 */
    AWRTC_MBEDTLS_SSL_EARLY_DATA_STATE_NO_IND_SENT,
 ...
 */
    AWRTC_MBEDTLS_SSL_EARLY_DATA_STATE_IND_SENT,
 ...
 */
    AWRTC_MBEDTLS_SSL_EARLY_DATA_STATE_SERVER_FINISHED_RECEIVED,

} awrtc_mbedtls_ssl_early_data_state;
 ...
 * when awrtc_mbedtls_ssl_conf_curves() is deleted.
 *
 * ssl->handshake->group_list is either a translation of curve_list to IANA TLS group
 * identifiers when awrtc_mbedtls_ssl_conf_curves() has been used, or a pointer to
 * ssl->conf->group_list when awrtc_mbedtls_ssl_conf_groups() has been more recently invoked.
 *
 */
static inline const void *awrtc_mbedtls_ssl_get_groups(const awrtc_mbedtls_ssl_context *ssl)
{
    #if defined(AWRTC_MBEDTLS_DEPRECATED_REMOVED) || !defined(AWRTC_MBEDTLS_ECP_C)
 ...
 */
static inline int awrtc_mbedtls_ssl_tls12_named_group_is_ecdhe(uint16_t named_group)
{
    /*
     * RFC 8422 section 5.1.1
     */
    return named_group == AWRTC_MBEDTLS_SSL_IANA_TLS_GROUP_X25519    ||
           named_group == AWRTC_MBEDTLS_SSL_IANA_TLS_GROUP_BP256R1   ||
           named_group == AWRTC_MBEDTLS_SSL_IANA_TLS_GROUP_BP384R1   ||
           named_group == AWRTC_MBEDTLS_SSL_IANA_TLS_GROUP_BP512R1   ||
           named_group == AWRTC_MBEDTLS_SSL_IANA_TLS_GROUP_X448      ||
           /* Below deprecated curves should be removed with notice to users */
           named_group == AWRTC_MBEDTLS_SSL_IANA_TLS_GROUP_SECP192K1 ||
           named_group == AWRTC_MBEDTLS_SSL_IANA_TLS_GROUP_SECP192R1 ||
           named_group == AWRTC_MBEDTLS_SSL_IANA_TLS_GROUP_SECP224K1 ||
           named_group == AWRTC_MBEDTLS_SSL_IANA_TLS_GROUP_SECP224R1 ||
           named_group == AWRTC_MBEDTLS_SSL_IANA_TLS_GROUP_SECP256K1 ||
           named_group == AWRTC_MBEDTLS_SSL_IANA_TLS_GROUP_SECP256R1 ||
           named_group == AWRTC_MBEDTLS_SSL_IANA_TLS_GROUP_SECP384R1 ||
           named_group == AWRTC_MBEDTLS_SSL_IANA_TLS_GROUP_SECP521R1;
}

static inline int awrtc_mbedtls_ssl_tls13_named_group_is_ecdhe(uint16_t named_group)
{
    return named_group == AWRTC_MBEDTLS_SSL_IANA_TLS_GROUP_X25519    ||
           named_group == AWRTC_MBEDTLS_SSL_IANA_TLS_GROUP_SECP256R1 ||
           named_group == AWRTC_MBEDTLS_SSL_IANA_TLS_GROUP_SECP384R1 ||
...
static inline int awrtc_mbedtls_ssl_tls13_named_group_is_ffdh(uint16_t named_group)
{
    return named_group >= AWRTC_MBEDTLS_SSL_IANA_TLS_GROUP_FFDHE2048 &&
           named_group <= AWRTC_MBEDTLS_SSL_IANA_TLS_GROUP_FFDHE8192;
}

static inline int awrtc_mbedtls_ssl_named_group_is_offered(
    const awrtc_mbedtls_ssl_context *ssl, uint16_t named_group)
{
...
static inline int awrtc_mbedtls_ssl_named_group_is_supported(uint16_t named_group)
{
#if defined(AWRTC_PSA_WANT_ALG_ECDH)
    if (awrtc_mbedtls_ssl_tls13_named_group_is_ecdhe(named_group)) {
        if (awrtc_mbedtls_ssl_get_ecp_group_id_from_tls_id(named_group) !=
    ...
    if (awrtc_mbedtls_ssl_tls13_named_group_is_ffdh(named_group)) {
        return 1;
    }
#endif
#if !defined(AWRTC_PSA_WANT_ALG_ECDH) && !defined(AWRTC_PSA_WANT_ALG_FFDH)
 ...
 * awrtc_mbedtls_ssl_conf_sig_hashes() is deleted.
 *
 * ssl->handshake->sig_algs is either a translation of sig_hashes to IANA TLS
 * signature algorithm identifiers when awrtc_mbedtls_ssl_conf_sig_hashes() has been
 * used, or a pointer to ssl->conf->sig_algs when awrtc_mbedtls_ssl_conf_sig_algs() has
 * been more recently invoked.
 *
 */
static inline const void *awrtc_mbedtls_ssl_get_sig_algs(
    const awrtc_mbedtls_ssl_context *ssl)
{
#if defined(AWRTC_MBEDTLS_SSL_HANDSHAKE_WITH_CERT_ENABLED)
...
#else /* AWRTC_MBEDTLS_SSL_HANDSHAKE_WITH_CERT_ENABLED */
...
#if defined(AWRTC_MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL_ENABLED)
static inline int awrtc_mbedtls_ssl_sig_alg_is_received(const awrtc_mbedtls_ssl_context *ssl,
...
static inline int awrtc_mbedtls_ssl_tls13_sig_alg_for_cert_verify_is_supported(
    const uint16_t sig_alg)
{
    switch (sig_alg) {
#if defined(AWRTC_MBEDTLS_PK_CAN_ECDSA_SOME)
#if defined(AWRTC_PSA_WANT_ALG_SHA_256) && defined(AWRTC_PSA_WANT_ECC_SECP_R1_256)
        case AWRTC_MBEDTLS_TLS1_3_SIG_ECDSA_SECP256R1_SHA256:
            break;
#endif /* AWRTC_PSA_WANT_ALG_SHA_256 && AWRTC_MBEDTLS_ECP_DP_SECP256R1_ENABLED */
#if defined(AWRTC_PSA_WANT_ALG_SHA_384) && defined(AWRTC_PSA_WANT_ECC_SECP_R1_384)
        case AWRTC_MBEDTLS_TLS1_3_SIG_ECDSA_SECP384R1_SHA384:
            break;
#endif /* AWRTC_PSA_WANT_ALG_SHA_384 && AWRTC_MBEDTLS_ECP_DP_SECP384R1_ENABLED */
#if defined(AWRTC_PSA_WANT_ALG_SHA_512) && defined(AWRTC_PSA_WANT_ECC_SECP_R1_521)
        case AWRTC_MBEDTLS_TLS1_3_SIG_ECDSA_SECP521R1_SHA512:
            break;
#endif /* AWRTC_PSA_WANT_ALG_SHA_512 && AWRTC_MBEDTLS_ECP_DP_SECP521R1_ENABLED */
...
static inline int awrtc_mbedtls_ssl_tls13_sig_alg_is_supported(
    const uint16_t sig_alg)
{
    switch (sig_alg) {
        ...
        default:
            return awrtc_mbedtls_ssl_tls13_sig_alg_for_cert_verify_is_supported(
                sig_alg);
    }
    return 1;
}
...
#if defined(AWRTC_MBEDTLS_SSL_HANDSHAKE_WITH_CERT_ENABLED)
static inline int awrtc_mbedtls_ssl_sig_alg_is_offered(const awrtc_mbedtls_ssl_context *ssl,
...
static inline int awrtc_mbedtls_ssl_get_pk_type_and_md_alg_from_sig_alg(
    uint16_t sig_alg, awrtc_mbedtls_pk_type_t *pk_type, awrtc_mbedtls_md_type_t *md_alg)
{
    *pk_type = awrtc_mbedtls_ssl_pk_alg_from_sig(sig_alg & 0xff);
    *md_alg = awrtc_mbedtls_ssl_md_alg_from_hash((sig_alg >> 8) & 0xff);

    if (*pk_type != AWRTC_MBEDTLS_PK_NONE && *md_alg != AWRTC_MBEDTLS_MD_NONE) {
        return 0;
    }
...
#if defined(AWRTC_MBEDTLS_MD_CAN_SHA256)
        case AWRTC_MBEDTLS_TLS1_3_SIG_RSA_PSS_RSAE_SHA256:
            *md_alg = AWRTC_MBEDTLS_MD_SHA256;
            *pk_type = AWRTC_MBEDTLS_PK_RSASSA_PSS;
            break;
#endif /* AWRTC_MBEDTLS_MD_CAN_SHA256  */
#if defined(AWRTC_MBEDTLS_MD_CAN_SHA384)
        case AWRTC_MBEDTLS_TLS1_3_SIG_RSA_PSS_RSAE_SHA384:
            *md_alg = AWRTC_MBEDTLS_MD_SHA384;
            *pk_type = AWRTC_MBEDTLS_PK_RSASSA_PSS;
            break;
#endif /* AWRTC_MBEDTLS_MD_CAN_SHA384 */
#if defined(AWRTC_MBEDTLS_MD_CAN_SHA512)
        case AWRTC_MBEDTLS_TLS1_3_SIG_RSA_PSS_RSAE_SHA512:
            *md_alg = AWRTC_MBEDTLS_MD_SHA512;
            *pk_type = AWRTC_MBEDTLS_PK_RSASSA_PSS;
            break;
#endif /* AWRTC_MBEDTLS_MD_CAN_SHA512 */
#endif /* AWRTC_MBEDTLS_PKCS1_V21 */
...
#if defined(AWRTC_MBEDTLS_SSL_PROTO_TLS1_2)
static inline int awrtc_mbedtls_ssl_tls12_sig_alg_is_supported(
    const uint16_t sig_alg)
{
    /* High byte is hash */
    unsigned char hash = AWRTC_MBEDTLS_BYTE_1(sig_alg);
    unsigned char sig = AWRTC_MBEDTLS_BYTE_0(sig_alg);
...
static inline int awrtc_mbedtls_ssl_sig_alg_is_supported(
    const awrtc_mbedtls_ssl_context *ssl,
    const uint16_t sig_alg)
{
    ...
    if (ssl->tls_version == AWRTC_MBEDTLS_SSL_VERSION_TLS1_2) {
        return awrtc_mbedtls_ssl_tls12_sig_alg_is_supported(sig_alg);
    }
#endif /* AWRTC_MBEDTLS_SSL_PROTO_TLS1_2 */

#if defined(AWRTC_MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL_ENABLED)
    if (ssl->tls_version == AWRTC_MBEDTLS_SSL_VERSION_TLS1_3) {
        return awrtc_mbedtls_ssl_tls13_sig_alg_is_supported(sig_alg);
    }
#endif
    ((void) ssl);
    ((void) sig_alg);
...
#if defined(AWRTC_MBEDTLS_USE_PSA_CRYPTO) || defined(AWRTC_MBEDTLS_SSL_PROTO_TLS1_3)
/* Corresponding PSA algorithm for AWRTC_MBEDTLS_CIPHER_NULL.
 * Same value is used for AWRTC_PSA_ALG_CATEGORY_CIPHER, hence it is
 * guaranteed to not be a valid PSA algorithm identifier.
 */
#define AWRTC_MBEDTLS_SSL_NULL_CIPHER 0x04000000

/**
 * \brief       Translate mbedtls cipher type/taglen pair to psa:
 *              algorithm, key type and key size.
 *
 * \param  awrtc_mbedtls_cipher_type [in] given mbedtls cipher type
 * \param  taglen              [in] given tag length
 *                                  0 - default tag length
 * \param  alg                 [out] corresponding PSA alg
 *                                   There is no corresponding PSA
 *                                   alg for AWRTC_MBEDTLS_CIPHER_NULL, so
 *                                   in this case AWRTC_MBEDTLS_SSL_NULL_CIPHER
 *                                   is returned via this parameter
 * \param  key_type            [out] corresponding PSA key type
 * \param  key_size            [out] corresponding PSA key size
 *
 * \return                     AWRTC_PSA_SUCCESS on success or AWRTC_PSA_ERROR_NOT_SUPPORTED if
 ...
 */
static inline AWRTC_MBEDTLS_DEPRECATED int awrtc_psa_ssl_status_to_mbedtls(awrtc_psa_status_t status)
{
    switch (status) {
        ...
        case AWRTC_PSA_ERROR_NOT_SUPPORTED:
            return AWRTC_MBEDTLS_ERR_SSL_FEATURE_UNAVAILABLE;
        case AWRTC_PSA_ERROR_INVALID_SIGNATURE:
...
} awrtc_mbedtls_ecjpake_rounds_t;
 ...
 * \param  round    [in] either AWRTC_MBEDTLS_ECJPAKE_ROUND_ONE or
 *                       AWRTC_MBEDTLS_ECJPAKE_ROUND_TWO
 *
 ...
 */
typedef enum {
    AWRTC_MBEDTLS_SSL_MODE_STREAM = 0,
    AWRTC_MBEDTLS_SSL_MODE_CBC,
    AWRTC_MBEDTLS_SSL_MODE_CBC_ETM,
    AWRTC_MBEDTLS_SSL_MODE_AEAD
} awrtc_mbedtls_ssl_mode_t;
...
static inline int awrtc_mbedtls_ssl_tls13_cipher_suite_is_offered(
    awrtc_mbedtls_ssl_context *ssl, int cipher_suite)
{
...
#if defined(AWRTC_MBEDTLS_SSL_RECORD_SIZE_LIMIT)
#define AWRTC_MBEDTLS_SSL_RECORD_SIZE_LIMIT_EXTENSION_DATA_LENGTH (2)
#define AWRTC_MBEDTLS_SSL_RECORD_SIZE_LIMIT_MIN (64)      /* As defined in RFC 8449 */
 ...
 */
AWRTC_MBEDTLS_CHECK_RETURN_CRITICAL
int awrtc_mbedtls_ssl_tls13_write_identities_of_pre_shared_key_ext(
    awrtc_mbedtls_ssl_context *ssl,
 ...
 */
AWRTC_MBEDTLS_CHECK_RETURN_CRITICAL
int awrtc_mbedtls_ssl_tls13_write_binders_of_pre_shared_key_ext(
    awrtc_mbedtls_ssl_context *ssl,
    unsigned char *buf, unsigned char *end);
 ...
 *         \c NULL if awrtc_mbedtls_ssl_set_hostname() has never been called on
...
#define AWRTC_MBEDTLS_SSL_TLS1_3_MAX_ALLOWED_TICKET_LIFETIME (604800)

static inline unsigned int awrtc_mbedtls_ssl_tls13_session_get_ticket_flags(
    awrtc_mbedtls_ssl_session *session, unsigned int flags)
{
    return session->ticket_flags &
           (flags & AWRTC_MBEDTLS_SSL_TLS1_3_TICKET_FLAGS_MASK);
}

/**
 * Check if at least one of the given flags is set in
 * the session ticket. See the definition of
 * `AWRTC_MBEDTLS_SSL_TLS1_3_TICKET_FLAGS_MASK` to get all
 * permitted flags.
 */
static inline int awrtc_mbedtls_ssl_tls13_session_ticket_has_flags(
    awrtc_mbedtls_ssl_session *session, unsigned int flags)
{
    return awrtc_mbedtls_ssl_tls13_session_get_ticket_flags(session, flags) != 0;
}

static inline int awrtc_mbedtls_ssl_tls13_session_ticket_allow_psk(
    awrtc_mbedtls_ssl_session *session)
{
    return awrtc_mbedtls_ssl_tls13_session_ticket_has_flags(
        session, AWRTC_MBEDTLS_SSL_TLS1_3_TICKET_ALLOW_PSK_RESUMPTION);
}

static inline int awrtc_mbedtls_ssl_tls13_session_ticket_allow_psk_ephemeral(
    awrtc_mbedtls_ssl_session *session)
{
    return awrtc_mbedtls_ssl_tls13_session_ticket_has_flags(
        session, AWRTC_MBEDTLS_SSL_TLS1_3_TICKET_ALLOW_PSK_EPHEMERAL_RESUMPTION);
}

static inline unsigned int awrtc_mbedtls_ssl_tls13_session_ticket_allow_early_data(
    awrtc_mbedtls_ssl_session *session)
{
    return awrtc_mbedtls_ssl_tls13_session_ticket_has_flags(
        session, AWRTC_MBEDTLS_SSL_TLS1_3_TICKET_ALLOW_EARLY_DATA);
}

static inline void awrtc_mbedtls_ssl_tls13_session_set_ticket_flags(
    awrtc_mbedtls_ssl_session *session, unsigned int flags)
{
    session->ticket_flags |= (flags & AWRTC_MBEDTLS_SSL_TLS1_3_TICKET_FLAGS_MASK);
}

static inline void awrtc_mbedtls_ssl_tls13_session_clear_ticket_flags(
    awrtc_mbedtls_ssl_session *session, unsigned int flags)
{
    session->ticket_flags &= ~(flags & AWRTC_MBEDTLS_SSL_TLS1_3_TICKET_FLAGS_MASK);
}
...
#define AWRTC_MBEDTLS_SSL_SESSION_TICKETS_TLS1_2_BIT 0
#define AWRTC_MBEDTLS_SSL_SESSION_TICKETS_TLS1_3_BIT 1

#define AWRTC_MBEDTLS_SSL_SESSION_TICKETS_TLS1_2_MASK \
    (1 << AWRTC_MBEDTLS_SSL_SESSION_TICKETS_TLS1_2_BIT)
#define AWRTC_MBEDTLS_SSL_SESSION_TICKETS_TLS1_3_MASK \
    (1 << AWRTC_MBEDTLS_SSL_SESSION_TICKETS_TLS1_3_BIT)

#if defined(AWRTC_MBEDTLS_SSL_PROTO_TLS1_2)
static inline int awrtc_mbedtls_ssl_conf_get_session_tickets(
    const awrtc_mbedtls_ssl_config *conf)
{
    return conf->session_tickets & AWRTC_MBEDTLS_SSL_SESSION_TICKETS_TLS1_2_MASK ?
           AWRTC_MBEDTLS_SSL_SESSION_TICKETS_ENABLED :
           AWRTC_MBEDTLS_SSL_SESSION_TICKETS_DISABLED;
}
#endif /* AWRTC_MBEDTLS_SSL_PROTO_TLS1_2 */

#if defined(AWRTC_MBEDTLS_SSL_PROTO_TLS1_3)
static inline int awrtc_mbedtls_ssl_conf_is_signal_new_session_tickets_enabled(
    const awrtc_mbedtls_ssl_config *conf)
{
    return conf->session_tickets & AWRTC_MBEDTLS_SSL_SESSION_TICKETS_TLS1_3_MASK ?
...
#if defined(AWRTC_MBEDTLS_SSL_CLI_C) && defined(AWRTC_MBEDTLS_SSL_PROTO_TLS1_3)
int awrtc_mbedtls_ssl_tls13_finalize_client_hello(awrtc_mbedtls_ssl_context *ssl);
#endif

#if defined(AWRTC_MBEDTLS_TEST_HOOKS) && defined(AWRTC_MBEDTLS_SSL_SOME_SUITES_USE_MAC)
 ...
 *                          with awrtc_mbedtls_md_hmac_starts() and use one of the
 *                          following hashes: SHA-384, SHA-256, SHA-1 or MD-5.
 *                          It is reset using awrtc_mbedtls_md_hmac_reset() after
 ...
 *
 * \retval 0 on success.
 * \retval #AWRTC_MBEDTLS_ERR_PLATFORM_HW_ACCEL_FAILED
...
int awrtc_mbedtls_ct_hmac(awrtc_mbedtls_md_context_t *ctx,
                    ...
                    size_t max_data_len,
                    unsigned char *output);
#endif /* defined(AWRTC_MBEDTLS_USE_PSA_CRYPTO) */
#endif /* AWRTC_MBEDTLS_TEST_HOOKS && defined(AWRTC_MBEDTLS_SSL_SOME_SUITES_USE_MAC) */

 ...
 *        AWRTC_MBEDTLS_LMOTS_SHA256_N32_W8 in order to reduce complexity.
 */
/*
...
#ifndef AWRTC_MBEDTLS_LMOTS_H
#define AWRTC_MBEDTLS_LMOTS_H
...
#define AWRTC_MBEDTLS_LMOTS_PUBLIC_KEY_LEN(type) (AWRTC_MBEDTLS_LMOTS_TYPE_LEN + \
                                            AWRTC_MBEDTLS_LMOTS_I_KEY_ID_LEN + \
                                            AWRTC_MBEDTLS_LMOTS_Q_LEAF_ID_LEN + \
                                            AWRTC_MBEDTLS_LMOTS_N_HASH_LEN(type))

#define AWRTC_MBEDTLS_LMOTS_SIG_TYPE_OFFSET       (0)
#define AWRTC_MBEDTLS_LMOTS_SIG_C_RANDOM_OFFSET (AWRTC_MBEDTLS_LMOTS_SIG_TYPE_OFFSET + \
                                           AWRTC_MBEDTLS_LMOTS_TYPE_LEN)
#define AWRTC_MBEDTLS_LMOTS_SIG_SIGNATURE_OFFSET(type) (AWRTC_MBEDTLS_LMOTS_SIG_C_RANDOM_OFFSET + \
...
extern int (*awrtc_mbedtls_lmots_sign_private_key_invalidated_hook)(unsigned char *);
#endif /* defined(AWRTC_MBEDTLS_TEST_HOOKS) */

#if !defined(AWRTC_MBEDTLS_DEPRECATED_REMOVED)
/**
 * \brief                    This function converts a \ref awrtc_psa_status_t to a
 *                           low-level LMS error code.
 *
 * \param status             The awrtc_psa_status_t to convert
 *
 * \return                   The corresponding LMS error code.
 */
int AWRTC_MBEDTLS_DEPRECATED awrtc_mbedtls_lms_error_from_psa(awrtc_psa_status_t status);
#endif
 ...
 *                           #AWRTC_MBEDTLS_LMOTS_PUBLIC_KEY_LEN bytes will be read
 *                           from this.
 *
 ...
 *                           be at least #AWRTC_MBEDTLS_LMOTS_PUBLIC_KEY_LEN in size.
 *
 * \return         \c 0 on success.
 * \return         A non-zero error code on failure.
 */
 ...
 *                           awrtc_mbedtls_lmots_verify will be used for LMOTS
 *                           signature verification.
 *
 * \param params             The LMOTS parameter set, q and I values as an
 *                           awrtc_mbedtls_lmots_parameters_t struct.
 ...
 *                           #AWRTC_MBEDTLS_LMOTS_SIG_LEN bytes will be read from
 *                           this.
 * \param out                The buffer where the candidate public key will be
 *                           stored. Must be at least #AWRTC_MBEDTLS_LMOTS_N_HASH_LEN
 *                           bytes in size.
 *
 * \return         \c 0 on success.
 * \return         A non-zero error code on failure.
 ...
 *                           Must be at least #AWRTC_MBEDTLS_LMOTS_SIG_LEN in size.
 *
 * \return         \c 0 on success.
 * \return         A non-zero error code on failure.
 */

 ...
 */
#ifndef AWRTC_MBEDTLS_DEBUG_INTERNAL_H
#define AWRTC_MBEDTLS_DEBUG_INTERNAL_H

#include "../include/mbedtls/debug.h"

/* This should be equivalent to awrtc_mbedtls_snprintf(). But it might not be due
 ...
 *
 * Our library assumes that awrtc_mbedtls_snprintf() and other printf functions
...
int awrtc_mbedtls_debug_snprintf(char *dest, size_t maxlen,
                           const char *format, ...) AWRTC_MBEDTLS_PRINTF_ATTRIBUTE(3, 4);
/**
 * \brief    Print a message to the debug output. This function is always used
 *          through the AWRTC_MBEDTLS_SSL_DEBUG_MSG() macro, which supplies the ssl
...
void awrtc_mbedtls_debug_print_msg(const awrtc_mbedtls_ssl_context *ssl, int level,
                             ...
                             const char *format, ...) AWRTC_MBEDTLS_PRINTF_ATTRIBUTE(5, 6);

/**
 * \brief   Print the return value of a function to the debug output. This
 *          function is always used through the AWRTC_MBEDTLS_SSL_DEBUG_RET() macro,
 ...
 *          is always used through the AWRTC_MBEDTLS_SSL_DEBUG_BUF() macro,
 *          which supplies the ssl context, file and line number parameters.
 *
 * \param ssl       SSL context
 * \param level     error level of the debug message
 ...
 *          used through the AWRTC_MBEDTLS_SSL_DEBUG_MPI() macro, which supplies the
 ...
 *          used through the AWRTC_MBEDTLS_SSL_DEBUG_ECP() macro, which supplies the
 *          ssl context, file and line number parameters.
 *
 * \param ssl       SSL context
 * \param level     error level of the debug message
 ...
 *          function is always used through the AWRTC_MBEDTLS_SSL_DEBUG_CRT() macro,
 *          which supplies the ssl context, file and line number parameters.
 *
 * \param ssl       SSL context
 * \param level     error level of the debug message
...
/* Note: the AWRTC_MBEDTLS_ECDH_C guard here is mandatory because this debug function
...
} awrtc_mbedtls_debug_ecdh_attr;

/**
 * \brief   Print a field of the ECDH structure in the SSL context to the debug
 *          output. This function is always used through the
 *          AWRTC_MBEDTLS_SSL_DEBUG_ECDH() macro, which supplies the ssl context, file
...
#endif /* AWRTC_MBEDTLS_DEBUG_INTERNAL_H */

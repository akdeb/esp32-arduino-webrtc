...
#ifndef AWRTC_PSA_CRYPTO_CIPHER_H
#define AWRTC_PSA_CRYPTO_CIPHER_H
 ...
 *
 * \return  On success \c AWRTC_PSA_SUCCESS is returned and key_bits, mode and cipher_id
 *          are properly updated.
 *          \c AWRTC_PSA_ERROR_NOT_SUPPORTED is returned if the cipher algorithm is not
 *          supported.
 */

awrtc_psa_status_t awrtc_mbedtls_cipher_values_from_psa(awrtc_psa_algorithm_t alg, awrtc_psa_key_type_t key_type,
                                            size_t *key_bits, awrtc_mbedtls_cipher_mode_t *mode,
...
const awrtc_mbedtls_cipher_info_t *awrtc_mbedtls_cipher_info_from_psa(
    awrtc_psa_algorithm_t alg, awrtc_psa_key_type_t key_type, size_t key_bits,
    awrtc_mbedtls_cipher_id_t *cipher_id);
 ...
 * \retval #AWRTC_PSA_SUCCESS \emptydescription
 */
awrtc_psa_status_t awrtc_mbedtls_psa_cipher_abort(awrtc_mbedtls_psa_cipher_operation_t *operation);
 ...
 *         padding, and the ciphertext does not contain valid padding.
 */
awrtc_psa_status_t awrtc_mbedtls_psa_cipher_encrypt(const awrtc_psa_key_attributes_t *attributes,
 ...
 *         padding, and the ciphertext does not contain valid padding.
 */
awrtc_psa_status_t awrtc_mbedtls_psa_cipher_decrypt(const awrtc_psa_key_attributes_t *attributes,
                                        const uint8_t *key_buffer,
                                        size_t key_buffer_size,
                                        awrtc_psa_algorithm_t alg,
                                        const uint8_t *input,
...
#endif /* AWRTC_PSA_CRYPTO_CIPHER_H */

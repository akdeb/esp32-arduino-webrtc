...
#ifndef AWRTC_MBEDTLS_BIGNUM_MOD_RAW_H
#define AWRTC_MBEDTLS_BIGNUM_MOD_RAW_H
 ...
 * \return       #AWRTC_MBEDTLS_ERR_MPI_BAD_INPUT_DATA if the external representation
 ...
 *                 a call to `awrtc_mbedtls_mpi_mod_raw_inv_prime()`.
 *
 ...
 *                 `awrtc_mbedtls_mpi_mod_raw_inv_prime()`.
 *
 ...
 *                   by `awrtc_mbedtls_mpi_mod_raw_inv_prime_working_limbs()`.
 ...
 *
 * \return          \c 0 if successful.
 *                  Otherwise an \c AWRTC_MBEDTLS_ERR_MPI_xxx error code.
 */
...
#endif /* AWRTC_MBEDTLS_BIGNUM_MOD_RAW_H */

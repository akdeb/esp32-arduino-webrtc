 ...
 */
#if !defined(AWRTC_MBEDTLS_SSL_TLS1_3_KEYS_H)
#define AWRTC_MBEDTLS_SSL_TLS1_3_KEYS_H

/* This requires AWRTC_MBEDTLS_SSL_TLS1_3_LABEL( idx, name, string ) to be defined at
 * the point of use. See e.g. the definition of awrtc_mbedtls_ssl_tls13_labels_union
 * below. */
#define AWRTC_MBEDTLS_SSL_TLS1_3_LABEL_LIST                                             \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(finished, "finished") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(resumption, "resumption") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(traffic_upd, "traffic upd") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(exporter, "exporter") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(key, "key") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(iv, "iv") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(c_hs_traffic, "c hs traffic") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(c_ap_traffic, "c ap traffic") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(c_e_traffic, "c e traffic") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(s_hs_traffic, "s hs traffic") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(s_ap_traffic, "s ap traffic") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(s_e_traffic, "s e traffic") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(e_exp_master, "e exp master") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(res_master, "res master") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(exp_master, "exp master") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(ext_binder, "ext binder") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(res_binder, "res binder") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(derived, "derived") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(client_cv, "TLS 1.3, client CertificateVerify") \
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(server_cv, "TLS 1.3, server CertificateVerify")

#define AWRTC_MBEDTLS_SSL_TLS1_3_CONTEXT_UNHASHED 0
#define AWRTC_MBEDTLS_SSL_TLS1_3_CONTEXT_HASHED   1

#define AWRTC_MBEDTLS_SSL_TLS1_3_PSK_EXTERNAL   0
#define AWRTC_MBEDTLS_SSL_TLS1_3_PSK_RESUMPTION 1

#if defined(AWRTC_MBEDTLS_SSL_PROTO_TLS1_3)

/* We need to tell the compiler that we meant to leave out the null character. */
#define AWRTC_MBEDTLS_SSL_TLS1_3_LABEL(name, string)       \
    const unsigned char name    [sizeof(string) - 1] AWRTC_MBEDTLS_ATTRIBUTE_UNTERMINATED_STRING;

union awrtc_mbedtls_ssl_tls13_labels_union {
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL_LIST
};
struct awrtc_mbedtls_ssl_tls13_labels_struct {
    AWRTC_MBEDTLS_SSL_TLS1_3_LABEL_LIST
};
#undef AWRTC_MBEDTLS_SSL_TLS1_3_LABEL

extern const struct awrtc_mbedtls_ssl_tls13_labels_struct awrtc_mbedtls_ssl_tls13_labels;

#define AWRTC_MBEDTLS_SSL_TLS1_3_LBL_LEN(LABEL)  \
    sizeof(awrtc_mbedtls_ssl_tls13_labels.LABEL)

#define AWRTC_MBEDTLS_SSL_TLS1_3_LBL_WITH_LEN(LABEL)  \
    awrtc_mbedtls_ssl_tls13_labels.LABEL,              \
    AWRTC_MBEDTLS_SSL_TLS1_3_LBL_LEN(LABEL)

/* Maximum length of the label field in the HkdfLabel struct defined in
 * RFC 8446, Section 7.1, excluding the "tls13 " prefix. */
#define AWRTC_MBEDTLS_SSL_TLS1_3_HKDF_LABEL_MAX_LABEL_LEN 249
...
#define AWRTC_MBEDTLS_SSL_TLS1_3_KEY_SCHEDULE_MAX_CONTEXT_LEN  \
...
#define AWRTC_MBEDTLS_SSL_TLS1_3_KEY_SCHEDULE_MAX_EXPANSION_LEN \
    (255 * AWRTC_MBEDTLS_TLS1_3_MD_MAX_SIZE)
 ...
 *                   (value AWRTC_MBEDTLS_SSL_TLS1_3_CONTEXT_HASHED), or whether
 *                   it is the content of \c Messages itself, in which case
 *                   the function takes care of the hashing
 *                   (value AWRTC_MBEDTLS_SSL_TLS1_3_CONTEXT_UNHASHED).
 ...
 *
 *        This is a small wrapper invoking awrtc_mbedtls_ssl_tls13_derive_secret()
 ...
 *        further processed by awrtc_mbedtls_ssl_tls13_make_traffic_keys().
 *
 ...
 *        awrtc_mbedtls_ssl_tls13_create_psk_binder().
 *
 ...
 * see e.g. awrtc_mbedtls_ssl_tls13_make_traffic_keys().
 *
 ...
 *                    be \c NULL if AWRTC_MBEDTLS_DEBUG_C is disabled.
 ...
 *                    provisioned (#AWRTC_MBEDTLS_SSL_TLS1_3_PSK_EXTERNAL) or a
 *                    resumption PSK (#AWRTC_MBEDTLS_SSL_TLS1_3_PSK_RESUMPTION).
 ...
 *                     been initialized through awrtc_mbedtls_ssl_transform_init() and
 ...
 *                     (value #AWRTC_MBEDTLS_SSL_IS_CLIENT) or the server
 *                     (value #AWRTC_MBEDTLS_SSL_IS_SERVER).
 ...
 *                     #AWRTC_MBEDTLS_DEBUG_C is set, and is ignored otherwise.
 *
 * \return             \c 0 on success. In this case, \p transform is ready to
 *                     be used with awrtc_mbedtls_ssl_transform_decrypt() and
 *                     awrtc_mbedtls_ssl_transform_encrypt().
 * \return             A negative error code on failure.
 */
AWRTC_MBEDTLS_CHECK_RETURN_CRITICAL
int awrtc_mbedtls_ssl_tls13_populate_transform(awrtc_mbedtls_ssl_transform *transform,
                                         int endpoint,
                                         int ciphersuite,
 ...
 *
 * Small wrappers around awrtc_mbedtls_ssl_tls13_evolve_secret().
 */
 ...
 *             awrtc_mbedtls_ssl_tls13_key_schedule_stage_application().
 *
 * \returns    \c 0 on success.
 * \returns    A negative error code on failure.
 */
 ...
 *                   - #AWRTC_MBEDTLS_SSL_IS_CLIENT for the Client's Finished message
 *                   - #AWRTC_MBEDTLS_SSL_IS_SERVER for the Server's Finished message
 *
 ...
 *             awrtc_mbedtls_ssl_tls13_key_schedule_stage_early() before to
...
#endif /* AWRTC_MBEDTLS_SSL_TLS1_3_KEYS_H */

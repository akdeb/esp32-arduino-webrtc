...
#ifndef AWRTC_PSA_CRYPTO_PAKE_H
#define AWRTC_PSA_CRYPTO_PAKE_H
 ...
 *                             the documentation of awrtc_psa_crypto_driver_pake_step_t for
 *                             more information.
 * \param output_size          Size of the \p output buffer in bytes. This must
 *                             be at least #AWRTC_PSA_PAKE_OUTPUT_SIZE(\p alg, \p
 ...
 *       transparent drivers.
 *
 * \note The core checks that input_length is smaller than AWRTC_PSA_PAKE_INPUT_MAX_SIZE.
 *
 * \param[in,out] operation    Active PAKE operation.
 * \param step                 The driver step for which the input is provided.
 * \param[in] input            Buffer containing the input in the format
 *                             appropriate for this \p step. Refer to the
 *                             documentation of awrtc_psa_crypto_driver_pake_step_t

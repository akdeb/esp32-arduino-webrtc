 ...
 */
#ifndef AWRTC_MBEDTLS_BN_MUL_H
#define AWRTC_MBEDTLS_BN_MUL_H
 ...
 * build lists of awrtc_mbedtls_mpi_uint's from lists of unsigned char's grouped by 8, 4 or 2
 */
#if defined(AWRTC_MBEDTLS_HAVE_INT32)

#define AWRTC_MBEDTLS_BYTES_TO_T_UINT_4(a, b, c, d)               \
    ((awrtc_mbedtls_mpi_uint) (a) <<  0) |                        \
    ((awrtc_mbedtls_mpi_uint) (b) <<  8) |                        \
    ((awrtc_mbedtls_mpi_uint) (c) << 16) |                        \
    ((awrtc_mbedtls_mpi_uint) (d) << 24)

#define AWRTC_MBEDTLS_BYTES_TO_T_UINT_2(a, b)                   \
    AWRTC_MBEDTLS_BYTES_TO_T_UINT_4(a, b, 0, 0)

#define AWRTC_MBEDTLS_BYTES_TO_T_UINT_8(a, b, c, d, e, f, g, h) \
    AWRTC_MBEDTLS_BYTES_TO_T_UINT_4(a, b, c, d),                \
    AWRTC_MBEDTLS_BYTES_TO_T_UINT_4(e, f, g, h)
...
#define AWRTC_MBEDTLS_BYTES_TO_T_UINT_8(a, b, c, d, e, f, g, h)   \
    ...
    ((awrtc_mbedtls_mpi_uint) (c) << 16) |                        \
    ((awrtc_mbedtls_mpi_uint) (d) << 24) |                        \
    ((awrtc_mbedtls_mpi_uint) (e) << 32) |                        \
    ((awrtc_mbedtls_mpi_uint) (f) << 40) |                        \
    ((awrtc_mbedtls_mpi_uint) (g) << 48) |                        \
    ((awrtc_mbedtls_mpi_uint) (h) << 56)

#define AWRTC_MBEDTLS_BYTES_TO_T_UINT_4(a, b, c, d)             \
    AWRTC_MBEDTLS_BYTES_TO_T_UINT_8(a, b, c, d, 0, 0, 0, 0)

#define AWRTC_MBEDTLS_BYTES_TO_T_UINT_2(a, b)                   \
    AWRTC_MBEDTLS_BYTES_TO_T_UINT_8(a, b, 0, 0, 0, 0, 0, 0)

#endif /* bits in awrtc_mbedtls_mpi_uint */
 ...
 * AWRTC_MBEDTLS_ASM_AARCH64_PTR_CONSTRAINT in common.h), especially on aarch64_32 (aka ILP32).
 *
...
#define MULADDC_X1_STOP                                                 \
         ...
         : "x4", "x5", "x6", "x7", "cc"                                 \
    ); d = (awrtc_mbedtls_mpi_uint *)muladdc_d; s = (awrtc_mbedtls_mpi_uint *)muladdc_s; } while (0);
...
#define MULADDC_X1_INIT                            \
    {                                              \
        awrtc_mbedtls_mpi_uint tmp_a, tmp_b;             \
        asm volatile (
...
#define MULADDC_X2_INIT                              \
    {                                                \
        awrtc_mbedtls_mpi_uint tmp_a0, tmp_b0;             \
        awrtc_mbedtls_mpi_uint tmp_a1, tmp_b1;             \
        asm volatile (
...
#define MULADDC_X1_INIT                 \
{                                       \
    awrtc_mbedtls_t_udbl r;                           \
    awrtc_mbedtls_mpi_uint r0, r1;

#define MULADDC_X1_CORE                 \
    r   = *(s++) * (awrtc_mbedtls_t_udbl) b;          \
    r0  = (awrtc_mbedtls_mpi_uint) r;                   \
    r1  = (awrtc_mbedtls_mpi_uint)( r >> biL );         \
    r0 += c;  r1 += (r0 <  c);          \
    r0 += *d; r1 += (r0 < *d);          \
    c = r1; *(d++) = r0;
...
#else /* AWRTC_MBEDTLS_HAVE_UDBL */

#define MULADDC_X1_INIT                 \
{                                       \
    awrtc_mbedtls_mpi_uint s0, s1, b0, b1;              \
    awrtc_mbedtls_mpi_uint r0, r1, rx, ry;              \
    b0 = ( b << biH ) >> biH;           \
    b1 = ( b >> biH );

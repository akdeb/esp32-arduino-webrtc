...
#ifndef AWRTC_PSA_CRYPTO_ECP_H
#define AWRTC_PSA_CRYPTO_ECP_H
 ...
 *                          when done.
 */
awrtc_psa_status_t awrtc_mbedtls_psa_ecp_load_representation(awrtc_psa_key_type_t type,
                                                 size_t curve_bits,
                                                 const uint8_t *data,
                                                 size_t data_length,
 ...
 *
 * \return AWRTC_PSA_SUCCESS on success, otherwise an MPI error.
 */
 ...
 *
 * \retval #AWRTC_PSA_SUCCESS  The ECP key was imported successfully.
 ...
 *                              \p data
 *
 * \retval #AWRTC_PSA_SUCCESS  The ECP public key was exported successfully.
 * \retval #AWRTC_PSA_ERROR_NOT_SUPPORTED \emptydescription
 ...
 *         #AWRTC_PSA_SIGN_OUTPUT_SIZE(\c AWRTC_PSA_KEY_TYPE_ECC_KEY_PAIR, \c key_bits,

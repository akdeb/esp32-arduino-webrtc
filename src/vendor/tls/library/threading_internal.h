...
#ifndef AWRTC_MBEDTLS_THREADING_INTERNAL_H
#define AWRTC_MBEDTLS_THREADING_INTERNAL_H
...
#define AWRTC_MBEDTLS_THREADING_INTERNAL_VERSION 0x03060000

#endif /* AWRTC_MBEDTLS_THREADING_INTERNAL_H */

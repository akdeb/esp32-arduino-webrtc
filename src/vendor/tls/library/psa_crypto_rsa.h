...
#ifndef AWRTC_PSA_CRYPTO_RSA_H
#define AWRTC_PSA_CRYPTO_RSA_H
 ...
 *                          when done.
 */
awrtc_psa_status_t awrtc_mbedtls_psa_rsa_load_representation(awrtc_psa_key_type_t type,
                                                 const uint8_t *data,
                                                 size_t data_length,
 ...
 *
 * \retval #AWRTC_PSA_SUCCESS  The RSA key was imported successfully.
 ...
 *                              \p data.
 *
 * \retval #AWRTC_PSA_SUCCESS  The RSA public key was exported successfully.
 * \retval #AWRTC_PSA_ERROR_NOT_SUPPORTED \emptydescription
 ...
 *         #AWRTC_PSA_SIGN_OUTPUT_SIZE(\c AWRTC_PSA_KEY_TYPE_RSA_KEY_PAIR, \c key_bits,

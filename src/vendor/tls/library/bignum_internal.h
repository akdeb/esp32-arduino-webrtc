 ...
 */
#ifndef AWRTC_MBEDTLS_BIGNUM_INTERNAL_H
#define AWRTC_MBEDTLS_BIGNUM_INTERNAL_H
 ...
 * \return         \c 0 if successful.
 * \return         #AWRTC_MBEDTLS_ERR_MPI_ALLOC_FAILED if a memory allocation failed.
 * \return         #AWRTC_MBEDTLS_ERR_MPI_BAD_INPUT_DATA if preconditions were not
 *                 met.
 */
 ...
 * \return         #AWRTC_MBEDTLS_ERR_MPI_BAD_INPUT_DATA if preconditions were not
 *                 met.
 * \return         #AWRTC_MBEDTLS_ERR_MPI_NOT_ACCEPTABLE if A is not invertible mod N.
 */

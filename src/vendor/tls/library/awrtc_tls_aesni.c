...
#if AWRTC_MBEDTLS_AESNI_HAVE_CODE == 2
#if defined(__GNUC__)
#include <cpuid.h>
#elif defined(_MSC_VER)
#include <intrin.h>
#else
#error "`__cpuid` required by AWRTC_MBEDTLS_AESNI_C is not supported by the compiler"
#endif
#include <immintrin.h>
#endif
                                 ...
                                 const unsigned char *key)
{
     ...
     * see definition of awrtc_mbedtls_aes_context.buf
     */
...
#else /* AWRTC_MBEDTLS_AESNI_HAVE_CODE == 1 */

#if defined(__has_feature)
#if __has_feature(memory_sanitizer)
#warning \
    "AWRTC_MBEDTLS_AESNI_C is known to cause spurious error reports with some memory sanitizers as they do not understand the assembly code."
#endif
#endif
